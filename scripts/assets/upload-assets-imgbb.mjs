...
// src/lib/features/tickets/assets/_meta/imgbb-map.json con la relación nombre → URL pública.
// Tras subir: `npm run assets:prune` para quitar los binarios locales ya mapeados.
//
// Uso:
