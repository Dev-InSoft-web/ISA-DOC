/** Bosquejo MERGE Ultra (×13) — el lote ejecutable completo no se incrusta en el HTML del ticket. */
export const SQL_MERGE_ULTRA_TK1433943 = `SET NOCOUNT ON;
SET XACT_ABORT ON;
BEGIN TRAN;

MERGE INSTRUCCION AS t
USING (VALUES (N'<TIPO>', N'PROMPT_<TIPO>', N'<texto Ultra>', N'Prompt Ultra · <TIPO>', N'2.0-ultra', 1)) AS s (...)
