...
![DER de Capacitación](/assets/imgs/DER%20Capacitaci%C3%B3n.jpg)

> El esquema completo se encuentra en
> `public/assets/imgs/DER Capacitación.jpg`. `RECURSO_EXTERNO` (cuando aparece)
...
![Propagación de GET en Capacitación](/assets/imgs/DER%20GET.png)
...
![Propagación de UPDATE/CREATE/DELETE en Capacitación](/assets/imgs/DER%20UPDATE.png)
...
![Diagrama ORM — Mapeo Relacional de Objetos](/assets/imgs/Diagrama%20ORM%20%28Mapeo%20Relacional%20de%20Objetos%291.jpg)
