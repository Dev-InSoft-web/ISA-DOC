...
export const TICKETS: TicketRegistro[] = [
		...
		cambiosBd: [
			{
				...
				sql: [
					...
					"",
					"SELECT [IINSTRUCCION], [NINSTRUCCION], [MODELO], [BACTIVO]",
	...
	},
	{
		...
		commits: [
			{ hash: "b6d714e", descripcion: "refactor(TK-1431163): Se compacta configuración de arranque para despliegue del backend", repo: "PatyIA", ins: 1, del: 3, fecha: "2026-06-02T07:22:39-05:00" },
			{ hash: "97cbb95", descripcion: "feat(TK-1431163): Se simplifica integración con el proveedor de IA y validación de tokens", repo: "PatyIA", ins: 79, del: 353, fecha: "2026-06-01T15:14:53-05:00" },
			{ hash: "59f05df", descripcion: "feat(TK-1431163): Se mejora manejo de hilos, mensajes y clasificación con razonamiento configurable", repo: "PatyIA", ins: 165, del: 196, fecha: "2026-06-01T14:04:52-05:00" },
			{ hash: "1101d47", descripcion: "feat(TK-1431163): Se envían instrucciones por tipo y nombre de usuario como variables del prompt general", repo: "PatyIA", ins: 183, del: 105, fecha: "2026-06-01T12:55:09-05:00" },
