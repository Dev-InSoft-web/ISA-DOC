...
import { sqlFilePath, parseSql } from "../schema/fragments.ts";
import { parseTableFragment, newTableId, type ParsedTable, type TableRow } from "../schema/tableSchema.ts";
import {
...
import {
	...
	masterPkOf,
} from "../../tree/nodes/index.ts";

const __filename = fileURLToPath(import.meta.url);
const __dirname = path.dirname(__filename);

export const clientesisDir = path.resolve(__dirname, "..", "..", "..", "..", "public", "data", "clientesis");
