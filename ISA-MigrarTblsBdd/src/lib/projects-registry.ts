...
export const PROJECTS: ProjectEntry[] = [
	...
	// 5) ISA-MigrarTblsBdd (este orquestador)
	{
		id: "isa",
		name: "ISA-MigrarTblsBdd",
		description: "Orquestador / panel de proyectos",
		icon: "mdi:view-dashboard-outline",
		cwd: `${base}/ClientesIS/doc/ISA-MigrarTblsBdd`,
		group: "clientesis",
		actions: [
			{ id: "isa-iconify", label: "Descargar iconos", type: "build", command: "npm run iconify", cwd: `${base}/ClientesIS/doc/ISA-MigrarTblsBdd`, description: "Iconify dl → public/icons/iconify" },
		],
	},
