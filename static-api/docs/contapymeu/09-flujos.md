...
```typescript
> ⚠ `ISP-CLientesISServer/src/sources/6.ContaPymeU/2.Capacitacion/02_Cursos.ts`: ENOENT: no such file or directory, open 'C:\Users\JAGUDELOE\Documents\ISP-CLientesISServer\src\sources\6.ContaPymeU\2.Capacitacion\02_Cursos.ts'
```
...
```typescript
> ⚠ `ISP-CLientesISServer/src/sources/6.ContaPymeU/2.Capacitacion/00_Base.ts`: ENOENT: no such file or directory, open 'C:\Users\JAGUDELOE\Documents\ISP-CLientesISServer\src\sources\6.ContaPymeU\2.Capacitacion\00_Base.ts'
```

```typescript
> ⚠ `ISP-CLientesISServer/src/sources/6.ContaPymeU/2.Capacitacion/01_PlanDeEstudio.ts`: ENOENT: no such file or directory, open 'C:\Users\JAGUDELOE\Documents\ISP-CLientesISServer\src\sources\6.ContaPymeU\2.Capacitacion\01_PlanDeEstudio.ts'
```
