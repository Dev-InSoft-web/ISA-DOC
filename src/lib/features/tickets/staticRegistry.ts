/** @deprecated Registro estático; usar `loadTickets()` (PG). Se mantiene como fallback sin lab API. */
import { SQL_MERGE_ULTRA_LOTE } from "./records/patyia/05/29/TK-1431666-sql";
import { SQL_CONVERSACION_LOG_DDL } from "./records/patyia/06/02/TK-1432903-sql";
import { SQL_MERGE_ULTRA_TK1433943 } from "./records/patyia/06/04/TK-1433943-sql";
// TK-1418988 no está en TICKETS[] — ver records/patyia/_draft/
import type { TicketNormativa, TicketRegistro } from "./types.js";
...
export const TICKETS: TicketRegistro[] = [
	{
		id: "TK-1433968",
		titulo: "Objetos Prompt OpenAI obsoletos (pmpt_*) — arquitectura Paty IA",
		solicitante: "Viviana Restrepo Quintero",
		fechaSolicitud: "04/jun./2026 09:50:34 am",
		noMaquillarFechas: true,
		resumen:
			"Se analizó el aviso de obsolescencia de objetos Prompt en OpenAI y se documentó la migración hacia instrucciones en base de datos y configuración local.",
		normativa: {
			...NORMATIVA_DEFAULT,
			medioAtencion: "Sistema de soporte",
			tipoSolicitud: "1 - Requerimiento técnico (para uso AT e ING únicamente)",
		},
		proyecto: "PatyIA",
	},
	{
		id: "TK-1433943",
		titulo: "Reforzar prompts Paty — actualizar instrucciones Ultra en base de datos",
		solicitante: "Viviana Restrepo Quintero",
		fechaSolicitud: "04/jun./2026 09:35:07 am",
		fechaEntrega: "04/jun./2026",
		noMaquillarFechas: true,
		estimacionMinutos: 45,
		diligenciaMinutos: 35,
		resumen:
			"Se reforzaron y desplegaron trece instrucciones Ultra en staging (MSSQL y PostgreSQL). Queda validación funcional en Paty V3/V4.",
		cambiosBd: [
			{
				tabla: "INSTRUCCION + TDCONSULTAXINSTRUCCION",
				registro: "13× PROMPT_<TIPO> · Ultra 2.0",
				intencion:
					"Se sobrescribió el texto de instrucción por tipo de consulta y se conservó el enlace TDCONSULTA→INSTRUCCION con orden 1, mediante lote idempotente en staging.",
				sql: SQL_MERGE_ULTRA_TK1433943,
			},
		],
		normativa: {
			...NORMATIVA_DEFAULT,
	...
	{
		id: "TK-1433179",
		titulo: "Implementar análisis de imágenes en Paty IA V4",
		solicitante: "Área funcional",
		fechaSolicitud: "02/jun./2026 05:14:59 pm",
		noMaquillarFechas: true,
		resumen:
			"Análisis e implementación de imágenes en el chat Paty IA V4: recepción, validación, envío al modelo con el texto del usuario y pruebas sin romper el flujo solo texto.",
		commits: [
			{
				hash: "1d0c754",
				descripcion:
	...
	{
		id: "TK-1432903",
		titulo: "Registro de log de peticiones de Paty IA",
		solicitante: "Área funcional",
		...
		cambiosBd: [
			{
				...
				registro: "Tabla de log JSON",
				intencion: "Tabla para persistir el JSON de métricas por conversación (ICONVERSACION + CONTENT).",
				sql: SQL_CONVERSACION_LOG_DDL,
			},
		],
		normativa: { ...NORMATIVA_DEFAULT, medioAtencion: "Asistencia remota", tipoSolicitud: "1 - PQR proyecto (para uso AT e ING únicamente)" },
		proyecto: "PatyIA",
	},
	{
		...
		cambiosExtraMinutos: 60,
		resumen: "Se actualizaron en AYUDASCP_IA los 13 prompts Ultra: textos compactos con ejemplos {{nombre_usuario}} en BD; resolución en runtime. Reducción ~41% del volumen de instrucción por turno (23 520 → 13 825 tokens).",
		commits: [
			{ hash: "44b6de6", repo: "ISA-DOC", descripcion: "feat(prompts): add new metrics script and enhance prompt handling", ins: 4419, del: 2383, fecha: "2026-06-02T11:49:24-05:00" },
			{ hash: "40995ce", repo: "ISA-DOC", descripcion: "feat(tickets): Se carga el visor de tickets de forma asíncrona y se mejora el manejo de errores", ins: 1330, del: 308, fecha: "2026-06-02T08:02:56-05:00" },
			{ hash: "ce07c0d", repo: "ISA-DOC", descripcion: "feat(prompts): enhance ultra prompts and integrate new SQL seed script", ins: 3991, del: 1971, fecha: "2026-06-02T07:20:36-05:00" },
			{ hash: "5701057", repo: "ISA-DOC", descripcion: "refactor(sql): remove obsolete scripts and update SQL references in components", ins: 224, del: 121, fecha: "2026-06-01T15:21:34-05:00" },
			{ hash: "26617c7", repo: "ISA-DOC", descripcion: "Add comprehensive guidelines for PATY system modes and responses in wenyan-ultra prompts", ins: 1049, del: 28, fecha: "2026-05-29T12:41:55-05:00" },
			{ hash: "9adce9d", repo: "ISA-DOC", descripcion: "Add new prompts for user assistance in ContaPyme", ins: 0, del: 0, fecha: "2026-05-29T12:34:21-05:00" },
			{ hash: "e714ffd", repo: "ISA-DOC", descripcion: "feat: add SQL scripts for cleaning and selecting instructions; implement API for local token retrieval and engine testing", ins: 6509, del: 91, fecha: "2026-05-29T12:20:50-05:00" },
		],
		cambiosBd: [
			{
				tabla: "INSTRUCCION + TDCONSULTAXINSTRUCCION (AYUDASCP_IA)",
				registro: "13 prompts PROMPT_<TIPO> — Ultra",
				intencion: "MERGE idempotente: textos Ultra (ejemplos con {{nombre_usuario}}); enlace TDCONSULTAXINSTRUCCION sin cambios.",
				sql: SQL_MERGE_ULTRA_LOTE,
			},
		],
	...
	},
	{
		...
		fechaSolicitud: "29/may./2026 08:42:16 am",
		noMaquillarFechas: true,
		estimacionMinutos: 130,
		diligenciaMinutos: 35,
		cambiosExtraMinutos: 60,
		resumen:
			"Se agregó INSTRUCCION.MODELO: clasificación vía OpenAI (PR_TIPO_CONSULTAS, operativo); respuesta por MODELO en BD (gpt-5-nano en 13 filas Ultra; fallback modeloConversacion). Métricas por turno. No se repitió el error por temperature (modelosSinTemperatura).",
		commits: [
			...
			{ hash: "309511f", repo: "ISA-DOC", descripcion: "feat(metrics): refactor conversation log metrics handling and enhance assistant field extraction", ins: 552, del: 177, fecha: "2026-06-02T10:50:04-05:00" },
			{ hash: "40995ce", repo: "ISA-DOC", descripcion: "feat(tickets): Se carga el visor de tickets de forma asíncrona y se mejora el manejo de errores", ins: 1330, del: 308, fecha: "2026-06-02T08:02:56-05:00" },
			...
			{ hash: "49a01b0", descripcion: "feat(TK-1431662): Se homogeneiza nomenclatura en controladores y se catalogan modelos sin temperatura", repo: "PatyIA", ins: 216, del: 254, fecha: "2026-06-01T12:49:57-05:00" },
			{ hash: "a581b9f", descripcion: "refactor(TK-1431662): Se compactan consultas de catálogos de tipos de consulta e instrucciones", repo: "PatyIA", ins: 9, del: 37, fecha: "2026-06-01T12:44:54-05:00" },
			{ hash: "00404cf", descripcion: "feat(TK-1431662): Se unifica la resolución del modelo en el flujo de conversación", repo: "PatyIA", ins: 105, del: 170, fecha: "2026-06-01T12:42:47-05:00" },
			{ hash: "05c6cef", descripcion: "feat(TK-1431662): Se agrega el modelo de respuesta por tipo de consulta desde la instrucción en base de datos", repo: "PatyIA", ins: 179, del: 176, fecha: "2026-06-01T11:57:14-05:00" },
			{ hash: "d113366", descripcion: "feat: se añade controlador para agilizar peticiones operativas", repo: "PatyIA", ins: 94, del: 0, fecha: "2026-05-29T15:38:15-05:00" },
			{ hash: "9eb1917", repo: "ISA-DOC", descripcion: "feat(conversaciones): update logging and metrics handling for conversation engines", ins: 804, del: 113, fecha: "2026-06-01T12:08:28-05:00" },
		],
		cambiosBd: [
			{
				tabla: "INSTRUCCION",
				registro: "Columna MODELO",
				intencion: "NVARCHAR(40) NOT NULL, default gpt-5-nano.",
				sql: [
					"SET NOCOUNT ON;",
					"SET XACT_ABORT ON;",
					"",
			...
			{
				tabla: "INSTRUCCION (staging)",
				registro: "Calibración MODELO",
				intencion: "UPDATE global a gpt-5-nano.",
				sql: [
					"SET NOCOUNT ON;",
					"SET XACT_ABORT ON;",
					"BEGIN TRAN;",
	...
	},
	{
		...
		resumen: "Se corrigió la composición OpenAI: PR_GENERAL v13 con variables nombre_usuario e instrucion_tipo (texto desde BD), sin instructions en el body. Se retiraron helpers redundantes en system-prompts.json, se mantuvieron vector stores y resolveUserNameInText.",
		commits: [
			{ hash: "62dbe22", descripcion: "refactor: Elimina instrucciones obsoletas de saludo y simplifica la estructura de archivos relacionados", repo: "PatyIA", ins: 1, del: 39, fecha: "2026-06-02T16:09:27-05:00", minutos: 4 },
			{ hash: "3321c35", descripcion: "feat: Actualiza el formato de las variables y optimiza la lógica para la recuperación de instrucciones.", repo: "PatyIA", ins: 97, del: 7, fecha: "2026-06-02T15:16:39-05:00", minutos: 12 },
			{ hash: "f3c1232", descripcion: "refactor(TK-1431163): Se depura la configuración de prompts del asistente", repo: "PatyIA", ins: 4, del: 32, fecha: "2026-06-02T11:54:57-05:00", minutos: 4 },
			{ hash: "12541df", descripcion: "refactor(TK-1431163): Se simplifica el armado de instrucciones en la respuesta al usuario", repo: "PatyIA", ins: 5, del: 5, fecha: "2026-06-02T11:54:47-05:00", minutos: 4 },
			{ hash: "535b636", descripcion: "feat(TK-1431163): Se registra petición y respuesta en clasificación de consultas y generación de título", repo: "PatyIA", ins: 26, del: 16, fecha: "2026-06-02T10:52:38-05:00", minutos: 10 },
			{ hash: "6327c2c", descripcion: "feat(TK-1431163): Se registra petición y respuesta en tareas operativas y en el historial de conversación", repo: "PatyIA", ins: 161, del: 26, fecha: "2026-06-02T10:52:22-05:00", minutos: 18 },
			{ hash: "7028397", descripcion: "refactor(TK-1431163): Se compacta la configuración de arranque para el despliegue", repo: "PatyIA", ins: 1, del: 3, fecha: "2026-06-02T07:22:39-05:00", minutos: 3 },
			{ hash: "40995ce", repo: "ISA-DOC", descripcion: "feat(tickets): Se carga el visor de tickets de forma asíncrona y se mejora el manejo de errores", ins: 1330, del: 308, fecha: "2026-06-02T08:02:56-05:00" },
			{ hash: "97cbb95", descripcion: "feat(TK-1431163): Se simplifica integración con el proveedor de IA y validación de tokens", repo: "PatyIA", ins: 79, del: 353, fecha: "2026-06-01T15:14:53-05:00", minutos: 25 },
			{ hash: "59f05df", descripcion: "feat(TK-1431163): Se mejora manejo de hilos, mensajes y clasificación con razonamiento configurable", repo: "PatyIA", ins: 165, del: 196, fecha: "2026-06-01T14:04:52-05:00", minutos: 30 },
			{ hash: "1101d47", descripcion: "feat(TK-1431163): Se envían instrucciones por tipo y nombre de usuario como variables del prompt general", repo: "PatyIA", ins: 183, del: 105, fecha: "2026-06-01T12:55:09-05:00", minutos: 35 },
			{ hash: "d8bf73b", descripcion: "refactor(TK-1431163): elimina controlador TGroqController y ajusta carga de precios en UlMetrics", repo: "PatyIA", ins: 19, del: 97, fecha: "2026-06-01T10:19:35-05:00", minutos: 20 },
			{ hash: "a9808b7", descripcion: "feat: Optimiza la gestión de conversaciones y prompts IA, integrando validación de esquemas, registro de métricas y utilidades de depuración.", repo: "PatyIA", ins: 630, del: 101, fecha: "2026-05-29T12:24:36-05:00", minutos: 75 },
			{ hash: "1097a76", repo: "ISA-DOC", descripcion: "docs(bitacora): agregar entrada diaria 2026-06-01 y ajustar referencias para TK-1431163", ins: 230, del: 148, fecha: "2026-06-01T10:26:34-05:00" },
		],
	...
	},
	{
		...
		extraMinutos: 10,
		commits: [
			{ hash: "a2d9474", repo: "ISA-DOC", descripcion: "refactor(tk-1429373): se actualizan nombres semánticos en español para NINSTRUCCION" },
			{ hash: "8f1fa35", repo: "ISA-DOC", descripcion: "feat(bitacora): se agrega accordion 2026-05-26 con sql exec para NINSTRUCCION semantico" },
			{ hash: "78b22cb", repo: "ISA-DOC", descripcion: "feat(patyia-bitacora): se agrega accordion 2026-05-26 con sql exec para NINSTRUCCION semantico" },
			{ hash: "2c287df", repo: "ISA-DOC", descripcion: "refactor(patyia-bitacora): se consolidan dos accordion sql del 2026-05-25 en uno solo" },
		],
		cambiosBd: [
			{
				tabla: "INSTRUCCION + TDCONSULTAXINSTRUCCION (AYUDASCP_IA)",
				...
				sql: [
					...
					"\tN'<TIPO>',",
					"\tN'PROMPT_<TIPO>',",
					"\tN'<contenido del archivo .md del prompt>',",
					...
					"USING (",
					"\tSELECT c.itdconsulta, N'<TIPO>' AS iinstruccion, 1 AS orden",
					"\tFROM TDCONSULTA c",
					"\tWHERE c.itdconsulta = N'<TIPO>'",
					") AS s",
			...
			{
				tabla: "INSTRUCCION (AYUDASCP_IA)",
				registro: "13 prompts PROMPT_<TIPO> — columna ninstruccion",
				intencion: "Se actualiza la columna ninstruccion de los 13 registros de INSTRUCCION con el nombre semántico en español para cada tipo de consulta (p.ej. ASESORIA_PERSONALIZADA → 'Asesoría Personalizada'). Idempotente. Se aplica con UPDATE...FROM INNER JOIN (VALUES) dentro de BEGIN TRAN / COMMIT con SET XACT_ABORT ON. Se esperan exactamente 13 filas afectadas.",
				sql: [
					"SET NOCOUNT ON;",
					"SET XACT_ABORT ON;",
					"BEGIN TRAN;",
	...
	},
	{
		...
		commits: [
			{ hash: "9f3247c", descripcion: "feat:  Se modifica TDriverServer para versiones expandidas de helpers, eliminandolos", repo: "ISP-CLientesISServer", ins: 30, del: 0, fecha: "2026-05-25T11:12:14-05:00" },
			{ hash: "ebe72f5", descripcion: "feat: elimina archivos TPlanDeEstudio y TCursos", repo: "ISP-CLientesISServer", ins: 0, del: 353, fecha: "2026-05-25T11:13:17-05:00" },
			{ hash: "9b7727b", descripcion: "feat: refactor TCapacitacionServer y elimina funciones no utilizadas", repo: "ISP-CLientesISServer", ins: 21, del: 107, fecha: "2026-05-25T11:13:31-05:00" },
			{ hash: "8f16432", descripcion: "feat: simplifica tipos en 000_UlTypes.ts y añade TPermisoServer", repo: "ISP-CLientesISServer", ins: 16, del: 51, fecha: "2026-05-25T11:14:15-05:00" },
			{ hash: "b816671", descripcion: "feat:  Se modifica TAtributosXDriverServer para versiones expandidas de helpers, eliminandolos", repo: "ISP-CLientesISServer", ins: 33, del: 0, fecha: "2026-05-25T11:14:48-05:00" },
			{ hash: "5763388", descripcion: "feat:  Se modifica TEstructuraCursoServer para versiones expandidas de helpers, eliminandolos", repo: "ISP-CLientesISServer", ins: 20, del: 0, fecha: "2026-05-25T11:15:22-05:00" },
			{ hash: "cfd07d8", descripcion: "feat:  Se modifica TSeguridadCursoServer para versiones expandidas de helpers, eliminandolos", repo: "ISP-CLientesISServer", ins: 34, del: 0, fecha: "2026-05-25T11:15:52-05:00" },
			{ hash: "e6563b0", descripcion: "feat:  Se modifica TAtributosPlanServer para versiones expandidas de helpers, eliminandolos", repo: "ISP-CLientesISServer", ins: 34, del: 0, fecha: "2026-05-25T11:16:20-05:00" },
			{ hash: "c923ea8", descripcion: "feat:  Se modifica TPlanCursoServer para versiones expandidas de helpers, eliminandolos", repo: "ISP-CLientesISServer", ins: 54, del: 0, fecha: "2026-05-25T11:16:53-05:00" },
			{ hash: "98f76cc", descripcion: "feat:  Se modifica TCursoServer para versiones expandidas de helpers, eliminandolos", repo: "ISP-CLientesISServer", ins: 129, del: 0, fecha: "2026-05-25T11:17:16-05:00" },
			{ hash: "250cf9c", descripcion: "feat:  Se modifica TCursoPrerequisitoServer para versiones expandidas de helpers, eliminandolos", repo: "ISP-CLientesISServer", ins: 33, del: 0, fecha: "2026-05-25T11:18:43-05:00" },
			{ hash: "00cccc1", descripcion: "feat:  Se modifica TCursoDePlanDeEstudioServer para versiones expandidas de helpers, eliminandolos", repo: "ISP-CLientesISServer", ins: 34, del: 0, fecha: "2026-05-25T11:19:11-05:00" },
			{ hash: "08b8987", descripcion: "feat:  Se modifica TPlanEstudioServer para versiones expandidas de helpers, eliminandolos", repo: "ISP-CLientesISServer", ins: 160, del: 0, fecha: "2026-05-25T11:19:47-05:00" },
			{ hash: "9bc1fee", descripcion: "feat: Mejora la función PromiseInsertQry en TAtributosXDriverServer", repo: "ISP-CLientesISServer", ins: 10, del: 7, fecha: "2026-05-25T11:34:05-05:00" },
			{ hash: "645214b", descripcion: "feat: Refactor PromiseInsertQry en TEstructuraCursoServer", repo: "ISP-CLientesISServer", ins: 10, del: 7, fecha: "2026-05-25T11:35:48-05:00" },
			{ hash: "3d0a2b4", descripcion: "feat: Mejora la función PromiseInsertQry en TSeguridadCursoServer para manejar listas vacías", repo: "ISP-CLientesISServer", ins: 10, del: 7, fecha: "2026-05-25T11:35:59-05:00" },
			{ hash: "54ca961", descripcion: "feat: actualiza la función PromiseInsertQry en TAtributosPlanServer", repo: "ISP-CLientesISServer", ins: 12, del: 8, fecha: "2026-05-25T11:36:34-05:00" },
			{ hash: "27a202a", descripcion: "feat: actualiza la función PromiseInsertQry en TPlanCursoServer", repo: "ISP-CLientesISServer", ins: 11, del: 8, fecha: "2026-05-25T11:36:51-05:00" },
			{ hash: "210b0e6", descripcion: "feat: actualiza la función PromiseInsertQry en TCursoPrerequisitoServer, TCursoDePlanDeEstudioServer", repo: "ISP-CLientesISServer", ins: 30, del: 21, fecha: "2026-05-25T11:37:26-05:00" },
			{ hash: "d0b798e", descripcion: "feat: actualiza el tipo de idriver a number en PromiseInsertQry de TAtributosXDriverServer", repo: "ISP-CLientesISServer", ins: 1, del: 1, fecha: "2026-05-25T11:44:10-05:00" },
		],
		normativa: { ...NORMATIVA_DEFAULT, medioAtencion: "Asistencia remota", tipoSolicitud: "1 - PQR Ajuste del sistema" },
	},
	{
	...
	},
	{
		...
		commits: [
			...
			{ hash: "19a3cac", descripcion: "fix(TK-1429342): se usa modo rapido y cancelar cierra el drawer del recurso en el arbol del curso", repo: "ISW-ClientesIS", ins: 6, del: 3, fecha: "2026-05-25T17:03:51-05:00" },
			{ hash: "ba3128d", descripcion: "fix(TK-1429342): se evita navegar fuera del curso al guardar el recurso editado desde el drawer", repo: "ISW-ClientesIS", ins: 8, del: 2, fecha: "2026-05-25T20:53:12-05:00" },
			{ hash: "6aa9d17", descripcion: "refactor(TK-1429342): se crea wrapper propio de acciones del recurso para el drawer del curso", repo: "ISW-ClientesIS", ins: 28, del: 13, fecha: "2026-05-25T21:54:59-05:00" },
			{ hash: "c6c2b0a", descripcion: "fix(TK-1429342): se corrige ruta relativa del formulario de recurso en el wrapper del drawer", repo: "ISW-ClientesIS", ins: 1, del: 1, fecha: "2026-05-25T21:56:39-05:00" },
			{ hash: "181848e", descripcion: "fix(TK-1429342): se mueve el titulo del drawer al contenido pues solo expone slot por defecto", repo: "ISW-ClientesIS", ins: 8, del: 6, fecha: "2026-05-25T21:59:03-05:00" },
			{ hash: "3d08a31", descripcion: "fix(TK-1429342): se carga el wrapper de acciones del recurso por import dinamico para evitar ciclo de modulos", repo: "ISW-ClientesIS", ins: 3, del: 2, fecha: "2026-05-25T22:03:07-05:00" },
			{ hash: "4428ea8", descripcion: "fix(controllers): se importa pluralize por namespace para evitar binding indefinido en interop cjs/esm", repo: "ISW-ClientesIS", ins: 3, del: 3, fecha: "2026-05-25T22:08:53-05:00" },
			{ hash: "3e2bf17", descripcion: "refactor(TK-1429342): se mueve la carga perezosa del wrapper de acciones al script para no inlinear import en la plantilla", repo: "ISW-ClientesIS", ins: 4, del: 2, fecha: "2026-05-26T07:20:06-05:00" },
	...
	},
	{
		...
		commits: [
			{ hash: "67ccd5d", descripcion: "feat(contapymeu): se persisten visible y orderby de columnas por controlador en localStorage para todos los catálogos", repo: "ISW-ClientesIS", ins: 36, del: 1, fecha: "2026-05-13T11:41:57-05:00" },
			...
			{ hash: "8e397c2", descripcion: "fix(contapymeu): se aplica persistencia de columnas de forma síncrona en el constructor para que el grid lea los valores ya rehidratados", repo: "ISW-ClientesIS", ins: 27, del: 17, fecha: "2026-05-13T11:47:23-05:00" },
	...
	},
	{
		...
		commits: [
			{ hash: "76edff7", descripcion: "feat(plan-estudio, curso): agrega nuevos endpoints para verificar, duplicar, recodificar y consolidar (TK-1426681)", repo: "ISP-ClientesIS", ins: 8, del: 0, fecha: "2026-05-21T10:15:34-05:00" },
			...
			{ hash: "ec3594f", descripcion: "feat(plan-estudio): agrega métodos para insertar detalles y manejar cursos y prerrequisitos en el plan de estudio (TK-1426681)", repo: "ISP-CLientesISServer", ins: 12, del: 13, fecha: "2026-05-21T10:15:03-05:00" },
		],
		normativa: { ...NORMATIVA_DEFAULT, tipoSolicitud: "1 - PQR Error del sistema" },
	},
	{
	...
	},
	{
		...
		commits: [
			...
			{ hash: "3a576ca", descripcion: "fix(capacitacion): se inicializa lista de planes al entrar al curso para habilitar agregar nodo raíz con árbol vacío", repo: "ISW-ClientesIS", ins: 2, del: 0, fecha: "2026-05-13T11:35:52-05:00" },
	...
	},
	{
		...
		commits: [
			{ hash: "d170267", descripcion: "fix(capacitacion): se habilitan crear/modificar/eliminar en list-slaves cuando el master está en edición y se oculta visualizar del catálogo de permisos", repo: "ISW-ClientesIS", ins: 4, del: 20, fecha: "2026-05-13T10:57:44-05:00" },
			{ hash: "be7682f", descripcion: "fix(capacitacion): se propaga el modo view del master a las acciones de los list-slaves y se agrega formulario de visualización del permiso en el btnref", repo: "ISW-ClientesIS", ins: 22, del: 2, fecha: "2026-05-13T10:53:03-05:00" },
			{ hash: "7e770eb", descripcion: "fix(capacitacion): se restringe el catálogo de permisos del BtnRef a solo visualización", repo: "ISW-ClientesIS", ins: 1, del: 0, fecha: "2026-05-13T10:49:20-05:00" },
			{ hash: "121aff1", descripcion: "fix(capacitacion): se oculta la acción modificar en el slave relacional de seguridad y se agrega formulario de solo visualización del permiso", repo: "ISW-ClientesIS", ins: 29, del: 10, fecha: "2026-05-13T10:46:51-05:00" },
	...
	},
	{
		...
		commits: [
			...
			{ hash: "8b1fefe", descripcion: "fix(treeview): se corrigió la ruta de los hijos y hermanos para que respeten el padre solicitante", repo: "ISW-ClientesIS", ins: 9, del: 24, fecha: "2026-05-08T10:04:13-05:00" },
	...
	},
	{
		...
		commits: [
			{ hash: "8f008b5", descripcion: "feat(TK-1422216): ajustar estilos y lógica de visualización en la tabla de cursos, mejorando la presentación y la experiencia de usuario", repo: "ISW-ClientesIS", ins: 32, del: 13, fecha: "2026-05-07T11:35:09-05:00" },
			...
			{ hash: "5270e8a", descripcion: "feat(ListCursosDePlan): mejorar la gestión de cursos al agregar detalles del curso y prerrequisitos; optimizar la referencia automática al abrir el botón de selección de curso.", repo: "ISW-ClientesIS", ins: 94, del: 24, fecha: "2026-05-07T09:10:32-05:00" },
			{ hash: "ef48d6e", descripcion: "feat(components): Se renombró el título a 'Cursos integrados' en `ListCursosDePlan` y se mejoró la lógica de exclusión en `PlanDeEstudio`, permitiendo ahora la selección del curso activo para su edición.", repo: "ISW-ClientesIS", ins: 4, del: 4, fecha: "2026-05-07T10:09:48-05:00" },
			...
			{ hash: "c010af1", descripcion: "feat(plandeestudio): agregar gestión de prerrequisitos en `ListPrerequisitosDePlan`, optimizar diseño en `ListCursosDePlan` y ajustar lógica en `Detail` para mejorar la experiencia de usuario", repo: "ISW-ClientesIS", ins: 208, del: 50, fecha: "2026-05-07T10:30:53-05:00" },
	...
	},
	{
		...
		commits: [
			{ hash: "6ce7d49", descripcion: "feat(cursos): ajuste varios en visualizador de cursos", repo: "ISW-ClientesIS", ins: 61, del: 7, fecha: "2026-05-05T15:34:21-05:00" },
	...
	},
	{
		...
		commits: [
			{ hash: "b4745b8", descripcion: "refactor(TK-1420813): comentar la línea que establece TCapacitacionBaseClient.local como true", repo: "ISW-ClientesIS", ins: 1, del: 1, fecha: "2026-05-05T14:14:20-05:00" },
			{ hash: "c9b7784", descripcion: "refactor(TK-1420813): simplificar la lógica de readonly en Detail.svelte, General.svelte, ListEstructura.svelte y ListSeguridad.svelte; agregar columnas de opciones en Cursos.ts", repo: "ISW-ClientesIS", ins: 20, del: 7, fecha: "2026-05-05T13:02:46-05:00" },
	...
	},
	{
		...
		commits: [
			...
			{ hash: "18fcc40", descripcion: "refactor(TK-1420742): simplificar propiedades y mejorar la semántica de color en Alert.svelte y AlertSimple.svelte feat(TreeContenidos): agregar métodos para preparar nodos en ContenidosTreeAdapter y optimizar la estructura en TreeContenidos.svelte fix(Cursos): establecer valores predeterminados para estructuras en TEstructuraCursoSlaveController", repo: "ISW-ClientesIS", ins: 87, del: 79, fecha: "2026-05-05T12:20:11-05:00" },
