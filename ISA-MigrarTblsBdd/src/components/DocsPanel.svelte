<script lang="ts">
	...
	import { getDocsForDerivative, type DocCategory, type DocItem } from "../lib/docs-registry";

	export let derivativeKey: string;

	$: categories = getDocsForDerivative(derivativeKey) as DocCategory[];
