...
2. Guardar cada archivo (`.jpg`, `.jpeg`, `.png`, `.gif` o `.webp`) bajo `doc/ISA-DOC/src/lib/tickets/assets/<TK-CODE>/<nombre-descriptivo>.jpg`. Una carpeta por TK; nombres en `camelCase` o `kebab-case`.
