<script context="module" lang="ts">
   ...
   import FloatingComponent from "../../../ui/containers/FloatingComponent.svelte";
   import type { INode, ITreeData } from "../TreeRowView.svelte";
   import type { TreeRowViewAdapterLegacy } from "../TreeRowView.svelte";

   export interface RowItemProps<TWorking extends ITreeData<TWorking>> extends HTMLAttributes<HTMLDivElement> {
      treeController: TreeRowViewAdapterLegacy<any, TWorking>;
