...
export const LOCAL_ENDPOINT_ROUTES: LocalEndpointRoute[] = [
	...
	{
		name: "API_POST_InsertarConversacionJailbreak",
		method: "POST",
		internalPattern: /^\/api\/patyia\/staging\/conversacion\/jailbreak$/,
		buildLocalUrl: () => `${LOCAL_BASE}/api/conversacion/jailbreak`,
	},
	{
...
export const ALL_LOCAL_ENDPOINTS: LocalEndpointDoc[] = [
	...
	{ name: "API_POST_InsertarConversacionJailbreak", method: "POST", path: "/api/conversacion/jailbreak" },
