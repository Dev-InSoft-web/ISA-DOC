...
<script context="module" lang="ts">
   ...
   import { TreeRowViewAdapterLegacy } from "./_asRow/01-treeAdapterAsRowEvents";
   export { ComplexControl, TreeRowViewAdapterLegacy, TreeRowAdapter, TreeNode, groupedWithSeparators, objRootsToNodes };
   ...
   export interface TreeViewProps<Stacker, TWorking extends ITreeData<TWorking>> extends HTMLAttributes<HTMLDivElement> {
      ...
      TreeController: TreeRowViewAdapterLegacy<Stacker, TWorking>;
      disabled?: boolean;
   ...
   export interface TreeViewSlots<Stacker, TWorking extends ITreeData<TWorking>> {
      default: { treeToolbar: TreeRowViewAdapterLegacy<Stacker, TWorking>; sizew: any; showEliminar: (Obj: TWorking) => void };
      pre: { treeToolbar: TreeRowViewAdapterLegacy<Stacker, TWorking>; sizew: any; showEliminar: (Obj: TWorking) => void };
      row: { node: TWorking };
      Frm: any;
   }
</script>
...
<script lang="ts" generics="Stacker, TWorking extends ITreeData<TWorking>">
   import { toastError } from "$lib/shared/stores";
   import TouchGestures from "../../ui/containers/TouchGestures.svelte";
