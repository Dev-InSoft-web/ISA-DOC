import{i as Qe,h as Ye,a as ge,p as ia}from"./props.CPnjtLwk.js";import{o as sa}from"./index-client.CRigskes.js";import{c as o,k as ta,f as we,g as a,h as d,r,v as E,p as Ue,l as Me,s as x,a as ca,b as v,u as U,t as Y,e as H,n as ie,i as He,m as D,o as fe,x as xe,w as Ce,q as Ge,j as la,y as De}from"./branches.xmzVy4Lo.js";import{F as Xe,e as Re,i as Fe,r as da,T as w,s as Ve,a as Ke,c as ua}from"./H6.svelte_svelte_type_style_lang.D1ZYTJSA.js";import{a as pa,c as Le,b as Te}from"./H4.Cp2HWCu3.js";import{a as ma}from"./event-modifiers.ixDJpjHw.js";import{r as fa}from"./render.6u3whji-.js";import{A as va}from"./Accordion.DIbQqEc3.js";import{B as ga}from"./BitacoraNote.D8jUDz-Q.js";import{a as ba}from"./actions.y5n11u_3.js";import{g as We}from"./marked.esm.DIGteVhe.js";import{L as ya,A as ha}from"./apiEndpoints.DOw-gxaW.js";import"./snippet.dv3dEBaI.js";import"./H2.CEP3cPk9.js";import"./RevisadoCheck.A9iZx76s.js";import"./CheckboxIcon.ClmrG_l9.js";import"./index.95NAa_60.js";const je="/ISA-DOC",Je=je!=="/",qa=je.endsWith("/")?je.slice(0,-1):je;function Ea(N){return N?/^[a-z]+:/i.test(N)||!N.startsWith("/")?N:qa+N:je}const $a=`# PROMPT · SALUDO_OTRO\r
\r
## Propósito\r
...
\r
El usuario debe sentirse atendido de forma cercana y natural, percibir fluidez en la conversación y mantener una experiencia agradable y coherente con la personalidad de Paty.`,Pa=`# PROMPT · FUERA_DE_ALCANCE_TECNICO\r
\r
## Propósito\r
...
- y continuar la conversación dentro del alcance funcional permitido`,Sa=`# PROMPT · SOLICITUD_NO_PERMITIDA\r
\r
## Propósito\r
...
- y, cuando aplique, continuar la conversación dentro de un uso correcto y permitido`,xa=`# PROMPT · REQUIERE_CONTEXTO\r
\r
## Propósito\r
...
## Resultado esperado\r
\r
El usuario debe entender con claridad por qué obtuvo ese resultado dentro del sistema, qué factores documentados influyen en él y cómo se relacionan entre sí, sin tener que interpretar por su cuenta la lógica de ContaPyme.`,ja=`# PROMPT · CONSULTA_NORMATIVA_NEGOCIO\r
\r
## Propósito\r
...
- y sentir una orientación clara, prudente y útil, sin recibir información normativa incorrecta`,_a=`# PROMPT · ASESORIA_PERSONALIZADA\r
\r
## Propósito\r
...
- y, cuando aplique, haber recibido antes la orientación general que sí podía atenderse dentro del alcance permitido`,ka=`# PROMPT · ERROR_TECNICO\r
\r
## Propósito\r
...
- y no recibir diagnósticos incorrectos ni soluciones no sustentadas`,wa=`# PROMPT · ERROR_CONFIGURACION\r
\r
## Propósito\r
...
- y ser redirigido correctamente a soporte cuando la información ya no sea suficiente o el caso requiera revisión específica`,Ra=`# PROMPT · ERROR_ACCESO\r
\r
## Propósito\r
...
- entender la posible causa del problema si existe evidencia\r
- o ser redirigido correctamente a soporte cuando se requiera una revisión más específica`,za=`# PROMPT · ERROR_DIAN\r
\r
## Propósito\r
...
- o ser orientado correctamente a soporte cuando no exista información suficiente o el caso requiera revisión específica`,Aa=`# PROMPT · COMERCIAL\r
\r
## Propósito\r
...
- y quedar orientado hacia precios, demo, plataforma o apoyo según el caso`;var Oa=E('<div class="patyia-prompts svelte-7w42dj"><!></div>');function Ia(N){const ae=[{title:"01. SALUDO_OTRO",icon:"mdi:hand-wave",md:$a},{title:"02. FUERA_DE_ALCANCE_TECNICO",icon:"mdi:alert-circle-outline",md:Pa},{title:"03. SOLICITUD_NO_PERMITIDA",icon:"mdi:cancel",md:Sa},{title:"04. REQUIERE_CONTEXTO",icon:"mdi:help-circle-outline",md:xa},{title:"05. PASO_A_PASO",icon:"mdi:format-list-numbered",md:Ca},{title:"06. INTERPRETACION_RESULTADO",icon:"mdi:chart-box-outline",md:Ta},{title:"07. CONSULTA_NORMATIVA_NEGOCIO",icon:"mdi:gavel",md:ja},{title:"08. ASESORIA_PERSONALIZADA",icon:"mdi:account-tie",md:_a},{title:"09. ERROR_TECNICO",icon:"mdi:bug-outline",md:ka},{title:"10. ERROR_CONFIGURACION",icon:"mdi:cog-outline",md:wa},{title:"11. ERROR_ACCESO",icon:"mdi:lock-alert-outline",md:Ra},{title:"12. ERROR_DIAN",icon:"mdi:file-document-alert-outline",md:za},{title:"13. COMERCIAL",icon:"mdi:cash-multiple",md:Aa}];var T=Oa(),m=o(T);Xe(m,{direction:"column",children:(k,R)=>{var M=ta(),V=we(M);Re(V,1,()=>ae,Fe,(_,G)=>{va(_,{get title(){return a(G).title},get titleIcon(){return a(G).icon},children:(ne,X)=>{ga(ne,{flat:!0,get mdSource(){return a(G).md}})},$$slots:{default:!0}})}),d(k,M)},$$slots:{default:!0}}),r(T),d(N,T)}const Na=JSON.parse('[{"familia":"Recommended","modelo":"gpt-5.5","costoEntrada":"$5.00","cacheEntrada":"$0.50","costoSalida":"$30.00","detalle":"A new class of intelligence for professional work"},{"familia":"Recommended","modelo":"gpt-5.4","costoEntrada":"$2.50","cacheEntrada":"$0.25","costoSalida":"$15.00","detalle":"Intelligence at scale for agents & professional work"},{"familia":"Recommended","modelo":"gpt-5.4-mini","costoEntrada":"$0.75","cacheEntrada":"$0.075","costoSalida":"$4.50","detalle":"Faster, cost-efficient version of GPT-5.4"},{"familia":"GPT-5","modelo":"gpt-5.4-nano","costoEntrada":"$0.20","cacheEntrada":"$0.02","costoSalida":"$1.25","detalle":"Fastest, most cost-efficient version of GPT-5.4"},{"familia":"GPT-5","modelo":"gpt-5.5-pro-2026-04-23","costoEntrada":"$30.00","cacheEntrada":"—","costoSalida":"$180.00","detalle":"Snapshot Pro (Alta capacidad)"},{"familia":"GPT-5","modelo":"gpt-5.5-pro","costoEntrada":"$30.00","cacheEntrada":"—","costoSalida":"$180.00","detalle":"Alias dinámico Pro"},{"familia":"GPT-5","modelo":"gpt-5.5-2026-04-23","costoEntrada":"$5.00","cacheEntrada":"$0.50","costoSalida":"$30.00","detalle":"Snapshot estándar v5.5"},{"familia":"GPT-5","modelo":"gpt-5.4-pro-2026-03-05","costoEntrada":"$15.00","cacheEntrada":"—","costoSalida":"$90.00","detalle":"Snapshot Pro anterior"},{"familia":"GPT-5","modelo":"gpt-5.4-pro","costoEntrada":"$15.00","cacheEntrada":"—","costoSalida":"$90.00","detalle":"Alias dinámico Pro anterior"},{"familia":"GPT-5","modelo":"gpt-5.4-nano-2026-03-17","costoEntrada":"$0.20","cacheEntrada":"$0.02","costoSalida":"$1.25","detalle":"Snapshot Nano v5.4"},{"familia":"GPT-5","modelo":"gpt-5.4-mini-2026-03-17","costoEntrada":"$0.75","cacheEntrada":"$0.075","costoSalida":"$4.50","detalle":"Snapshot Mini v5.4"},{"familia":"GPT-5","modelo":"gpt-5.4-2026-03-05","costoEntrada":"$2.50","cacheEntrada":"$0.25","costoSalida":"$15.00","detalle":"Snapshot estándar v5.4"},{"familia":"GPT-5","modelo":"gpt-5.3-codex","costoEntrada":"$1.50","cacheEntrada":"$0.15","costoSalida":"$6.00","detalle":"Optimizado para código avanzado"},{"familia":"GPT-5","modelo":"gpt-5.3-chat-latest","costoEntrada":"$1.50","cacheEntrada":"$0.15","costoSalida":"$6.00","detalle":"Alias para chat continuo v5.3"},{"familia":"GPT-5","modelo":"gpt-5.2-pro-2025-12-11","costoEntrada":"$15.00","cacheEntrada":"—","costoSalida":"$90.00","detalle":"Snapshot Pro histórico"},{"familia":"GPT-5","modelo":"gpt-5.2-pro","costoEntrada":"$15.00","cacheEntrada":"—","costoSalida":"$90.00","detalle":"Variante Pro histórica"},{"familia":"GPT-5","modelo":"gpt-5.2-codex","costoEntrada":"$1.50","cacheEntrada":"$0.15","costoSalida":"$6.00","detalle":"Optimizado para código v5.2"},{"familia":"GPT-5","modelo":"gpt-5.2-chat-latest","costoEntrada":"$1.25","cacheEntrada":"$0.125","costoSalida":"$5.00","detalle":"Histórico Chat v5.2"},{"familia":"GPT-5","modelo":"gpt-5.2-2025-12-11","costoEntrada":"$1.25","cacheEntrada":"$0.125","costoSalida":"$5.00","detalle":"Snapshot v5.2"},{"familia":"GPT-5","modelo":"gpt-5.2","costoEntrada":"$1.25","cacheEntrada":"$0.125","costoSalida":"$5.00","detalle":"Base v5.2"},{"familia":"GPT-5","modelo":"gpt-5.1-codex-mini","costoEntrada":"$0.40","cacheEntrada":"$0.04","costoSalida":"$1.60","detalle":"Código ligero v5.1"},{"familia":"GPT-5","modelo":"gpt-5.1-codex-max","costoEntrada":"$2.00","cacheEntrada":"$0.20","costoSalida":"$8.00","detalle":"Código pesado v5.1"},{"familia":"GPT-5","modelo":"gpt-5.1-codex","costoEntrada":"$1.25","cacheEntrada":"$0.125","costoSalida":"$5.00","detalle":"Código v5.1"},{"familia":"GPT-5","modelo":"gpt-5.1-chat-latest","costoEntrada":"$1.25","cacheEntrada":"$0.125","costoSalida":"$5.00","detalle":"Chat v5.1"},{"familia":"GPT-5","modelo":"gpt-5.1-2025-11-13","costoEntrada":"$1.25","cacheEntrada":"$0.125","costoSalida":"$5.00","detalle":"Snapshot v5.1"},{"familia":"GPT-5","modelo":"gpt-5.1","costoEntrada":"$1.25","cacheEntrada":"$0.125","costoSalida":"$5.00","detalle":"Base v5.1"},{"familia":"GPT-5","modelo":"gpt-5-pro-2025-10-06","costoEntrada":"$15.00","cacheEntrada":"—","costoSalida":"$90.00","detalle":"Primer Snapshot Pro v5"},{"familia":"GPT-5","modelo":"gpt-5-pro","costoEntrada":"$15.00","cacheEntrada":"—","costoSalida":"$90.00","detalle":"Alias inicial Pro v5"},{"familia":"GPT-5","modelo":"gpt-5-nano-2025-08-07","costoEntrada":"$0.15","cacheEntrada":"$0.015","costoSalida":"$0.60","detalle":"Snapshot Nano original"},{"familia":"GPT-5","modelo":"gpt-5-nano","costoEntrada":"$0.15","cacheEntrada":"$0.015","costoSalida":"$0.60","detalle":"Fastest, most cost-efficient version of GPT-5"},{"familia":"GPT-5","modelo":"gpt-5-mini-2025-08-07","costoEntrada":"$0.30","cacheEntrada":"$0.03","costoSalida":"$1.20","detalle":"Snapshot Mini original"},{"familia":"GPT-5","modelo":"gpt-5-mini","costoEntrada":"$0.30","cacheEntrada":"$0.03","costoSalida":"$1.20","detalle":"Smaller, faster version of GPT-5 for well-defined tasks"},{"familia":"GPT-5","modelo":"gpt-5-codex","costoEntrada":"$1.25","cacheEntrada":"$0.125","costoSalida":"$5.00","detalle":"Original Codex v5"},{"familia":"GPT-5","modelo":"gpt-5-chat-latest","costoEntrada":"$1.25","cacheEntrada":"$0.125","costoSalida":"$5.00","detalle":"Original Chat v5"},{"familia":"GPT-5","modelo":"gpt-5-2025-08-07","costoEntrada":"$1.25","cacheEntrada":"$0.125","costoSalida":"$5.00","detalle":"Snapshot inicial GPT-5"},{"familia":"GPT-5","modelo":"gpt-5","costoEntrada":"$1.25","cacheEntrada":"$0.125","costoSalida":"$5.00","detalle":"Modelo Base GPT-5 original"},{"familia":"GPT-4.1","modelo":"gpt-4.1","costoEntrada":"$2.00","cacheEntrada":"$0.50","costoSalida":"$8.00","detalle":"Smartest non-reasoning model"},{"familia":"GPT-4.1","modelo":"gpt-4.1-mini","costoEntrada":"$0.40","cacheEntrada":"$0.10","costoSalida":"$1.60","detalle":"Smaller, faster version of GPT-4.1"},{"familia":"GPT-4.1","modelo":"gpt-4.1-nano","costoEntrada":"$0.10","cacheEntrada":"$0.025","costoSalida":"$0.40","detalle":"Fastest, most cost-efficient version of GPT-4.1"},{"familia":"GPT-4.1","modelo":"gpt-4.1-nano-2025-04-14","costoEntrada":"$0.10","cacheEntrada":"$0.025","costoSalida":"$0.40","detalle":"Snapshot Nano 4.1"},{"familia":"GPT-4.1","modelo":"gpt-4.1-mini-2025-04-14","costoEntrada":"$0.40","cacheEntrada":"$0.10","costoSalida":"$1.60","detalle":"Snapshot Mini 4.1"},{"familia":"GPT-4.1","modelo":"gpt-4.1-2025-04-14","costoEntrada":"$2.00","cacheEntrada":"$0.50","costoSalida":"$8.00","detalle":"Snapshot Base 4.1"},{"familia":"Reasoning","modelo":"o3","costoEntrada":"$2.00","cacheEntrada":"$0.50","costoSalida":"$8.00","detalle":"Smartest reasoning model for complex tasks"},{"familia":"Reasoning","modelo":"o4-mini","costoEntrada":"$0.55","cacheEntrada":"$0.14","costoSalida":"$2.20","detalle":"Smaller, faster reasoning model"},{"familia":"Reasoning","modelo":"o1-pro","costoEntrada":"$60.00","cacheEntrada":"—","costoSalida":"$240.00","detalle":"A version of o1 that uses maximum compute"},{"familia":"Reasoning","modelo":"chat-latest","costoEntrada":"—","cacheEntrada":"—","costoSalida":"—","detalle":"Alias dinámico al último o-model"},{"familia":"Reasoning","modelo":"o1","costoEntrada":"$15.00","cacheEntrada":"$3.75","costoSalida":"$60.00","detalle":"Modelo de razonamiento base inicial"},{"familia":"Reasoning","modelo":"o1-2024-12-17","costoEntrada":"$15.00","cacheEntrada":"$3.75","costoSalida":"$60.00","detalle":"Snapshot o1 histórico"},{"familia":"Reasoning","modelo":"o1-pro-2025-03-19","costoEntrada":"$60.00","cacheEntrada":"—","costoSalida":"$240.00","detalle":"Snapshot o1-pro histórico"},{"familia":"Reasoning","modelo":"o3-2025-04-16","costoEntrada":"$2.00","cacheEntrada":"$0.50","costoSalida":"$8.00","detalle":"Snapshot o3 estándar"},{"familia":"Reasoning","modelo":"o3-mini","costoEntrada":"$1.10","cacheEntrada":"$0.55","costoSalida":"$4.40","detalle":"Versión optimizada de o3"},{"familia":"Reasoning","modelo":"o3-mini-2025-01-31","costoEntrada":"$1.10","cacheEntrada":"$0.55","costoSalida":"$4.40","detalle":"Snapshot o3-mini original"},{"familia":"Reasoning","modelo":"o4-mini-2025-04-16","costoEntrada":"$0.55","cacheEntrada":"$0.14","costoSalida":"$2.20","detalle":"Snapshot o4-mini estándar"},{"familia":"Reasoning","modelo":"o4-mini-deep-research","costoEntrada":"$2.00","cacheEntrada":"—","costoSalida":"$8.00","detalle":"Ejecución autónoma larga"},{"familia":"Reasoning","modelo":"o4-mini-deep-research-2025-06-26","costoEntrada":"$2.00","cacheEntrada":"—","costoSalida":"$8.00","detalle":"Snapshot de Deep Research"},{"familia":"GPT-4o","modelo":"gpt-4o","costoEntrada":"$2.50","cacheEntrada":"$1.25","costoSalida":"$10.00","detalle":"Modelo flagship multimodal clásico"},{"familia":"GPT-4o","modelo":"gpt-4o-mini","costoEntrada":"$0.15","cacheEntrada":"$0.075","costoSalida":"$0.60","detalle":"Modelo eficiente clásico"},{"familia":"GPT-4o","modelo":"gpt-4o-search-preview","costoEntrada":"$2.50","cacheEntrada":"—","costoSalida":"$10.00","detalle":"Fast, up-to-date answers with clear citations"},{"familia":"GPT-4o","modelo":"gpt-audio-mini-2025-12-15","costoEntrada":"$0.60 (Texto)","cacheEntrada":"—","costoSalida":"$2.40 (Texto)","detalle":"Snapshot Audio Mini (Audio: Input $10 / Output $20)"},{"familia":"GPT-4o","modelo":"gpt-audio-mini-2025-10-06","costoEntrada":"$0.60 (Texto)","cacheEntrada":"—","costoSalida":"$2.40 (Texto)","detalle":"Snapshot Audio Mini (Audio: Input $10 / Output $20)"},{"familia":"GPT-4o","modelo":"gpt-audio-mini","costoEntrada":"$0.60 (Texto)","cacheEntrada":"—","costoSalida":"$2.40 (Texto)","detalle":"Alias Audio Mini (Audio: Input $10 / Output $20)"},{"familia":"GPT-4o","modelo":"gpt-audio-2025-08-28","costoEntrada":"$4.00 (Texto)","cacheEntrada":"—","costoSalida":"$24.00 (Texto)","detalle":"Snapshot Audio Full (Audio: Input $32 / Output $64)"},{"familia":"GPT-4o","modelo":"gpt-audio-1.5","costoEntrada":"$4.00 (Texto)","cacheEntrada":"—","costoSalida":"$24.00 (Texto)","detalle":"Audio Flagship v1.5 (Audio: Input $32 / Output $64)"},{"familia":"GPT-4o","modelo":"gpt-audio","costoEntrada":"$4.00 (Texto)","cacheEntrada":"—","costoSalida":"$24.00 (Texto)","detalle":"Alias Audio Flagship (Audio: Input $32 / Output $64)"},{"familia":"GPT-4o","modelo":"gpt-4o-search-preview-2025-03-11","costoEntrada":"$2.50","cacheEntrada":"—","costoSalida":"$10.00","detalle":"Snapshot Search Preview"},{"familia":"GPT-4o","modelo":"gpt-4o-mini-search-preview-2025-03-11","costoEntrada":"$0.15","cacheEntrada":"—","costoSalida":"$0.60","detalle":"Snapshot Search Mini Preview"},{"familia":"GPT-4o","modelo":"gpt-4o-mini-search-preview","costoEntrada":"$0.15","cacheEntrada":"—","costoSalida":"$0.60","detalle":"Alias dinámico Search Mini"},{"familia":"GPT-4o","modelo":"gpt-4o-mini-2024-07-18","costoEntrada":"$0.15","cacheEntrada":"$0.075","costoSalida":"$0.60","detalle":"Snapshot original gpt-4o-mini"},{"familia":"GPT-4o","modelo":"gpt-4o-2024-11-20","costoEntrada":"$2.50","cacheEntrada":"$1.25","costoSalida":"$10.00","detalle":"Snapshot intermedio gpt-4o"},{"familia":"GPT-4o","modelo":"gpt-4o-2024-08-06","costoEntrada":"$2.50","cacheEntrada":"$1.25","costoSalida":"$10.00","detalle":"Snapshot estructurado gpt-4o"},{"familia":"GPT-4o","modelo":"gpt-4o-2024-05-13","costoEntrada":"$5.00","cacheEntrada":"—","costoSalida":"$15.00","detalle":"Snapshot de lanzamiento gpt-4o"},{"familia":"GPT-4","modelo":"gpt-4-turbo-2024-04-09","costoEntrada":"$10.00","cacheEntrada":"—","costoSalida":"$30.00","detalle":"Heredado Turbo Snapshot"},{"familia":"GPT-4","modelo":"gpt-4-turbo","costoEntrada":"$10.00","cacheEntrada":"—","costoSalida":"$30.00","detalle":"Heredado Turbo Alias"},{"familia":"GPT-4","modelo":"gpt-4-0613","costoEntrada":"$30.00","cacheEntrada":"—","costoSalida":"$60.00","detalle":"Heredado base (8K)"},{"familia":"GPT-4","modelo":"gpt-4","costoEntrada":"$30.00","cacheEntrada":"—","costoSalida":"$60.00","detalle":"Heredado base alias"},{"familia":"GPT-3.5","modelo":"gpt-3.5-turbo-16k","costoEntrada":"$3.00","cacheEntrada":"—","costoSalida":"$4.00","detalle":"Heredado 16k"},{"familia":"GPT-3.5","modelo":"gpt-3.5-turbo-1106","costoEntrada":"$1.00","cacheEntrada":"—","costoSalida":"$2.00","detalle":"Heredado snapshot"},{"familia":"GPT-3.5","modelo":"gpt-3.5-turbo-0125","costoEntrada":"$0.50","cacheEntrada":"—","costoSalida":"$1.50","detalle":"Heredado snapshot costo bajo"},{"familia":"GPT-3.5","modelo":"gpt-3.5-turbo","costoEntrada":"$0.50","cacheEntrada":"—","costoSalida":"$1.50","detalle":"Heredado alias estándar"}]');var Ma=E('<h3 style="margin: 0.75rem 0 0.25rem; font-size: 1rem; color: var(--is-text-secondary, #555);"> </h3> <div class="md-table svelte-1vy2fsm"></div>',1),Ga=E('<p style="color: #888; font-style: italic;"> </p>'),Da=E(`<h2 style="margin: 0 0 0.25rem;">Modelos OpenAI — Pricing</h2> <p style="margin: 0 0 0.75rem; color: #888; font-size: 0.85rem;">Costos por 1M tokens. Fuente: OpenAI API pricing (mayo 2026).</p> <input type="text" placeholder="Filtrar por modelo, familia o descripción…" style="
		...
		"/> <!> <!> <p style="margin-top: 1rem; color: #aaa; font-size: 0.75rem;"> <code>src/lib/patyia/openai-models-pricing.json</code></p>`,1);function La(N,ae){Ue(ae,!1);const T=D(),m=D(),k=D(),R=Na,M=g=>{const C=g.match(/\$(\d+(?:\.\d+)?)/);return C?parseFloat(C[1]):0},V=Math.max(...R.map(g=>M(g.costoEntrada))),_=Math.max(...R.map(g=>M(g.cacheEntrada))),G=Math.max(...R.map(g=>M(g.costoSalida))),ne="rgba(217, 70, 239, 0.28)",be=[{idx:1,max:V,color:ne},{idx:2,max:_,color:"rgba(160, 160, 160, 0.28)"},{idx:3,max:G,color:ne}],de=(g,C,F)=>{const z=M(g.textContent??"");if(!z||!C){g.style.background="";return}const j=Math.min(100,z/C*100);g.style.background=`linear-gradient(to right, ${F} ${j}%, transparent ${j}%)`};function ue(g){const C=()=>{g.querySelectorAll("tbody > tr").forEach(z=>{const j=z.querySelectorAll("td");for(const B of be){const se=j[B.idx];se&&de(se,B.max,B.color)}})};return C(),{update:C}}let W=D("");const re=g=>g.replace(/\|/g,"\\|").replace(/\n+/g," "),pe=g=>{const C=a(T).filter(j=>j.familia===g),F=`| Modelo (API ID) | Entrada | Caché | Salida | Detalle |
| --- | --- | --- | --- | --- |`,z=C.map(j=>`| \`${re(j.modelo)}\` | ${re(j.costoEntrada)} | ${re(j.cacheEntrada)} | ${re(j.costoSalida)} | ${re(j.detalle)} |`).join(`
`);return`${F}
${z}`};Me(()=>a(W),()=>{x(T,a(W).trim()?R.filter(g=>{const C=a(W).toLowerCase();return g.modelo.toLowerCase().includes(C)||g.familia.toLowerCase().includes(C)||g.detalle.toLowerCase().includes(C)}):R)}),Me(()=>a(T),()=>{x(m,[...new Set(a(T).map(g=>g.familia))])}),Me(()=>(a(m),We),()=>{x(k,a(m).map(g=>({familia:g,html:We.parse(pe(g))})))}),ca(),Qe(),Xe(N,{direction:"column",style:"padding: 1rem;",children:(g,C)=>{var F=Da(),z=v(we(F),4);da(z);var j=v(z,2);Re(j,1,()=>a(k),Fe,(L,A)=>{var K=Ma(),me=we(K),Z=o(me,!0);r(me);var oe=v(me,2);Ye(oe,()=>(a(A),U(()=>a(A).html)),!0),r(oe),ba(oe,(ee,J)=>ue?.(ee),()=>a(A).html),Y(()=>H(Z,(a(A),U(()=>a(A).familia)))),d(L,K)});var B=v(j,2);{var se=L=>{var A=Ga(),K=o(A);r(A),Y(()=>H(K,`Sin resultados para «${a(W)??""}».`)),d(L,A)};ge(B,L=>{a(T),U(()=>a(T).length===0)&&L(se)})}var te=v(B,2),ye=o(te);ie(),r(te),Y(()=>H(ye,`Total: ${a(T),U(()=>a(T).length)??""} modelos · JSON: `)),pa(z,()=>a(W),L=>x(W,L)),d(g,F)},$$slots:{default:!0}}),He()}var Qa=E('<code class="svelte-16kgkfd"> </code>'),Ua=E('<code class="svelte-16kgkfd"> </code>'),Ha=E('<span class="badge badge-ok svelte-16kgkfd" title="Mapeado en LOCAL_ENDPOINT_ROUTES">sí</span>'),Fa=E('<span class="badge badge-off svelte-16kgkfd" title="No mapeado todavía">no</span>'),Ba=E('<tr><td class="svelte-16kgkfd"><!></td><td class="svelte-16kgkfd"><span> </span></td><td class="svelte-16kgkfd"><!></td><td class="cell-center svelte-16kgkfd"><!></td></tr>'),Va=E('<code class="svelte-16kgkfd">/api/patyia/conversaciones</code>'),Wa=E('<code class="svelte-16kgkfd">API_GET_ConversacionesTercero</code>'),Ja=E('<code class="svelte-16kgkfd"></code>'),Ya=E('<code class="svelte-16kgkfd">API_GET_ObtenerConversacion</code>'),Xa=E('<code class="svelte-16kgkfd">/api/patyia/staging/conversacion/new</code>'),Ka=E('<code class="svelte-16kgkfd">API_POST_InsertarConversacion</code>'),Za=E('<code class="svelte-16kgkfd"></code>'),en=E('<code class="svelte-16kgkfd">API_POST_InsertarMensajeCalificado</code>'),an=E(`<div class="panel-wrap svelte-16kgkfd"><h2>Endpoints expuestos por server local</h2> <p>Base local: <code>http://localhost:7071</code>. La columna <strong>Wired</strong> indica si la ruta interna de
		ISA-DOC tiene mapeo en <code>LOCAL_ENDPOINT_ROUTES</code> y por tanto el switch <em>local</em> la redirige al
		server local.</p> <section class="run-summary svelte-16kgkfd"><header class="run-summary-head svelte-16kgkfd"><h3 class="svelte-16kgkfd">Estado de recepción — última corrida verify-api-patyia</h3> <span class="run-pill run-pill-ok svelte-16kgkfd">12/12 OK · 0 FAIL</span></header> <p class="run-meta svelte-16kgkfd">Corrida del <strong>2026-05-28 12:44:53</strong> contra <code>http://localhost:7071</code> con <code>codigotk=TKV999991</code>, <code>iconversacion=1802</code>, <code>itiquete=104</code>.
			Token cargado desde <code>token.patyia.json</code>. Cleanup completo (tiquete y conversación eliminados).</p> <ol class="run-steps svelte-16kgkfd"><li><span class="ok svelte-16kgkfd">✅</span> POST <code>/api/JWT</code> — autenticación</li> <li><span class="ok svelte-16kgkfd">✅</span> POST <code>/api/conversacion</code> — HTTP 200 (SSE, <code>iconversacion=1802</code>)</li> <li><span class="ok svelte-16kgkfd">✅</span> GET <code>/api/conversaciones</code> — HTTP 200</li> <li><span class="ok svelte-16kgkfd">✅</span> GET <code>/api/conversacion/1802</code> — HTTP 200</li> <li><span class="ok svelte-16kgkfd">✅</span> GET <code>/api/resumen_conversacion/1802</code> — HTTP 200</li> <li><span class="ok svelte-16kgkfd">✅</span> POST <code>/api/mensaje</code> — HTTP 201 (<code>imensaje=168</code>)</li> <li><span class="ok svelte-16kgkfd">✅</span> POST <code>/api/tiquete</code> — HTTP 201 (<code>itiquete=104</code>)</li> <li><span class="ok svelte-16kgkfd">✅</span> GET <code>/api/tiquete/104</code> — HTTP 200</li> <li><span class="ok svelte-16kgkfd">✅</span> GET <code>/api/tiquete/por-conversacion/1802</code> — HTTP 200</li> <li><span class="ok svelte-16kgkfd">✅</span> PATCH <code>/api/tiquete</code> — HTTP 200</li> <li><span class="ok svelte-16kgkfd">✅</span> GET <code>/api/timer_cerrarConversaciones</code> — HTTP 200</li> <li><span class="ok svelte-16kgkfd">✅</span> CLEANUP: DELETE <code>/api/tiquete/104</code> + DELETE <code>/api/conversacion/1802</code> — HTTP 200</li></ol> <p class="run-foot svelte-16kgkfd">Toda la batería se ejecutó de extremo a extremo: creación, lecturas, mutaciones y limpieza.
			El POST de conversación retorna <em>Server-Sent Events</em> y el script extrae <code>iconversacion</code> del primer evento <code>data:</code> para marcar la conversación como propia
			y limpiarla en el cleanup.</p></section> <div class="tbl-wrap svelte-16kgkfd"><table class="endpoints-tbl svelte-16kgkfd"><thead><tr><th title="Nombre del endpoint Azure Function" class="svelte-16kgkfd"><!></th><th title="Método HTTP" class="svelte-16kgkfd"><!></th><th title="Ruta relativa expuesta por el server local" class="svelte-16kgkfd"><!></th><th title="¿Está cableado en LOCAL_ENDPOINT_ROUTES del catálogo de ISA-DOC?" class="svelte-16kgkfd"><!></th></tr></thead><tbody></tbody></table></div> <h3>Mapeo interno → local</h3> <table class="endpoints-tbl svelte-16kgkfd"><thead><tr><th title="Ruta consumida internamente por el frontend de ISA-DOC" class="svelte-16kgkfd"><!></th><th title="Método HTTP" class="svelte-16kgkfd"><!></th><th title="Nombre del endpoint local al que se redirige" class="svelte-16kgkfd"><!></th></tr></thead><tbody><tr><td class="svelte-16kgkfd"><!></td><td class="svelte-16kgkfd"><span class="method method-get svelte-16kgkfd">GET</span></td><td class="svelte-16kgkfd"><!></td></tr><tr><td class="svelte-16kgkfd"><!></td><td class="svelte-16kgkfd"><span class="method method-get svelte-16kgkfd">GET</span></td><td class="svelte-16kgkfd"><!></td></tr><tr><td class="svelte-16kgkfd"><!></td><td class="svelte-16kgkfd"><span class="method method-post svelte-16kgkfd">POST</span></td><td class="svelte-16kgkfd"><!></td></tr><tr><td class="svelte-16kgkfd"><!></td><td class="svelte-16kgkfd"><span class="method method-post svelte-16kgkfd">POST</span></td><td class="svelte-16kgkfd"><!></td></tr></tbody></table> <h3>Convenciones visuales</h3> <ul><li>Botón con color <code>danger</code> → la acción se ejecutará contra el server local.</li> <li><code>title</code> con sufijo <code>· LOCAL &lt;nombre&gt;</code> → indica el endpoint exacto del local que se invocará.</li> <li>Sin color y sin sufijo → la acción se ejecuta contra origin.</li></ul></div>`);function nn(N,ae){Ue(ae,!1);const T=new Set(ya.map(l=>l.name)),m=ha.map(l=>({...l,wired:T.has(l.name)}));Qe();var k=an(),R=v(o(k),6),M=o(R),V=o(M),_=o(V),G=o(_),ne=o(G);w(ne,{lines:1,children:(l,$)=>{ie();var e=fe("Endpoint");d(l,e)},$$slots:{default:!0}}),r(G);var X=v(G),be=o(X);w(be,{lines:1,children:(l,$)=>{ie();var e=fe("Método");d(l,e)},$$slots:{default:!0}}),r(X);var de=v(X),ue=o(de);w(ue,{lines:1,children:(l,$)=>{ie();var e=fe("Ruta local");d(l,e)},$$slots:{default:!0}}),r(de);var W=v(de),re=o(W);w(re,{lines:1,children:(l,$)=>{ie();var e=fe("Wired");d(l,e)},$$slots:{default:!0}}),r(W),r(_),r(V);var pe=v(V);Re(pe,5,()=>m,l=>l.name,(l,$)=>{var e=Ba(),n=o(e),i=o(n);w(i,{lines:1,children:(p,O)=>{var Q=Qa(),Se=o(Q,!0);r(Q),Y(()=>H(Se,a($).name)),d(p,Q)},$$slots:{default:!0}}),r(n);var s=v(n),u=o(s),t=o(u,!0);r(u),r(s);var c=v(s),b=o(c);w(b,{lines:1,children:(p,O)=>{var Q=Ua(),Se=o(Q,!0);r(Q),Y(()=>H(Se,a($).path)),d(p,Q)},$$slots:{default:!0}}),r(c);var f=v(c),y=o(f);{var P=p=>{var O=Ha();d(p,O)},q=p=>{var O=Fa();d(p,O)};ge(y,p=>{a($).wired?p(P):p(q,-1)})}r(f),r(e),Y(p=>{Ve(n,"title",a($).name),Ke(u,1,`method method-${p??""}`,"svelte-16kgkfd"),H(t,a($).method),Ve(c,"title",a($).path)},[()=>a($).method.toLowerCase()]),d(l,e)}),r(pe),r(M),r(R);var g=v(R,4),C=o(g),F=o(C),z=o(F),j=o(z);w(j,{lines:1,children:(l,$)=>{ie();var e=fe("Ruta interna ISA-DOC");d(l,e)},$$slots:{default:!0}}),r(z);var B=v(z),se=o(B);w(se,{lines:1,children:(l,$)=>{ie();var e=fe("Método");d(l,e)},$$slots:{default:!0}}),r(B);var te=v(B),ye=o(te);w(ye,{lines:1,children:(l,$)=>{ie();var e=fe("Nombre local");d(l,e)},$$slots:{default:!0}}),r(te),r(F),r(C);var L=v(C),A=o(L),K=o(A),me=o(K);w(me,{lines:1,children:(l,$)=>{var e=Va();d(l,e)},$$slots:{default:!0}}),r(K);var Z=v(K,2),oe=o(Z);w(oe,{lines:1,children:(l,$)=>{var e=Wa();d(l,e)},$$slots:{default:!0}}),r(Z),r(A);var ee=v(A),J=o(ee),he=o(J);w(he,{lines:1,children:(l,$)=>{var e=Ja();e.textContent="/api/patyia/conversacion/{id}",d(l,e)},$$slots:{default:!0}}),r(J);var ce=v(J,2),ze=o(ce);w(ze,{lines:1,children:(l,$)=>{var e=Ya();d(l,e)},$$slots:{default:!0}}),r(ce),r(ee);var qe=v(ee),Ee=o(qe),$e=o(Ee);w($e,{lines:1,children:(l,$)=>{var e=Xa();d(l,e)},$$slots:{default:!0}}),r(Ee);var _e=v(Ee,2),Ae=o(_e);w(Ae,{lines:1,children:(l,$)=>{var e=Ka();d(l,e)},$$slots:{default:!0}}),r(_e),r(qe);var Pe=v(qe),ve=o(Pe),Oe=o(ve);w(Oe,{lines:1,children:(l,$)=>{var e=Za();e.textContent="/api/patyia/staging/conversacion/{id}/send-stream",d(l,e)},$$slots:{default:!0}}),r(ve);var ke=v(ve,2),Ie=o(ke);w(Ie,{lines:1,children:(l,$)=>{var e=en();d(l,e)},$$slots:{default:!0}}),r(ke),r(Pe),r(L),r(g),ie(4),r(k),d(N,k),He()}var rn=E('<div class="docs-loading svelte-1dlwdhb">Cargando documentación…</div>'),on=E('<div class="docs-error svelte-1dlwdhb"> </div>'),sn=E('<p class="docs-desc svelte-1dlwdhb"> </p>'),tn=E('<button type="button"><span class="docs-nav-num svelte-1dlwdhb"> </span> <span class="docs-nav-text"> </span></button>'),cn=E('<article class="docs-panel svelte-1dlwdhb"><!></article>'),ln=E('<article class="docs-panel svelte-1dlwdhb"><!></article>'),dn=E('<article class="docs-panel svelte-1dlwdhb"><!></article>'),un=E('<article class="docs-content svelte-1dlwdhb"></article>'),pn=E('<div class="docs-shell svelte-1dlwdhb"><aside class="docs-side svelte-1dlwdhb"><div class="docs-side-head svelte-1dlwdhb"><h2 class="docs-title svelte-1dlwdhb"> </h2> <!> <button type="button" class="docs-dl-all svelte-1dlwdhb" title="Ver el .md completo (todas las secciones unidas) en un visor"> </button></div> <nav class="docs-nav svelte-1dlwdhb"></nav></aside> <!></div>'),mn=E('<div class="md-modal-backdrop svelte-1dlwdhb" role="presentation"><div class="md-modal svelte-1dlwdhb" role="dialog" aria-modal="true" tabindex="-1"><header class="md-modal-head svelte-1dlwdhb"><h3 class="svelte-1dlwdhb"> </h3> <div class="md-modal-actions svelte-1dlwdhb"><!> <!> <!></div></header> <div class="md-modal-body svelte-1dlwdhb"><div class="md-cm-host svelte-1dlwdhb"></div></div></div></div>'),fn=E("<!> <!>",1);function Rn(N,ae){Ue(ae,!1);let T=ia(ae,"project",8,"contapymeu"),m=D(null),k=D(""),R=D(""),M=D(!0),V=D(""),_=D(),G=!1;const ne=new Set;function X(e){return new Promise((n,i)=>{const s=document.createElement("script");s.src=e,s.onload=()=>n(),s.onerror=()=>i(new Error(`No se pudo cargar ${e}`)),document.head.appendChild(s)})}function be(e){if(document.querySelector(`link[href="${e}"]`))return;const n=document.createElement("link");n.rel="stylesheet",n.href=e,document.head.appendChild(n)}async function de(){window.marked||await X("https://cdn.jsdelivr.net/npm/marked/marked.min.js")}const ue="https://cdn.jsdelivr.net/npm/codemirror@5.65.16",W={ts:{mode:"javascript",mime:"application/typescript",label:"TypeScript"},tsx:{mode:"javascript",mime:"application/typescript",label:"TypeScript"},typescript:{mode:"javascript",mime:"application/typescript",label:"TypeScript"},js:{mode:"javascript",mime:"text/javascript",label:"JavaScript"},jsx:{mode:"javascript",mime:"text/javascript",label:"JavaScript"},javascript:{mode:"javascript",mime:"text/javascript",label:"JavaScript"},json:{mode:"javascript",mime:"application/json",label:"JSON"},sql:{mode:"sql",mime:"text/x-sql",label:"SQL"},yaml:{mode:"yaml",mime:"text/x-yaml",label:"YAML"},yml:{mode:"yaml",mime:"text/x-yaml",label:"YAML"},bash:{mode:"shell",mime:"text/x-sh",label:"Shell"},sh:{mode:"shell",mime:"text/x-sh",label:"Shell"},shell:{mode:"shell",mime:"text/x-sh",label:"Shell"},powershell:{mode:"powershell",mime:"application/x-powershell",label:"PowerShell"},html:{mode:"xml",mime:"text/html",label:"HTML"},xml:{mode:"xml",mime:"application/xml",label:"XML"}};async function re(){if(window.CodeMirror){G=!0;return}try{be(`${ue}/lib/codemirror.min.css`),await X(`${ue}/lib/codemirror.min.js`),G=!0}catch{G=!1}}async function pe(e){if(!(!e||ne.has(e)))try{await X(`${ue}/mode/${e}/${e}.min.js`),ne.add(e)}catch{}}async function g(e){if(!G||!window.CodeMirror)return;const n=Array.from(e.querySelectorAll("pre > code")).filter(t=>!(t.className||"").includes("language-mermaid"));if(!n.length)return;const i=window.CodeMirror,s=new Set,u=[];for(const t of n){const f=((t.className||"").match(/language-([\w-]+)/)?.[1]??"").toLowerCase(),y=W[f];y&&s.add(y.mode),u.push({codeEl:t,lang:f,cfg:y})}await Promise.all([...s].map(t=>pe(t)));for(const{codeEl:t,lang:c,cfg:b}of u){const f=t.parentElement,y=t.textContent??"",P=document.createElement("div");if(P.className="is-codeblock",c){const p=document.createElement("div");p.className="is-codeblock-tag",p.textContent=b?.label??c.toUpperCase(),P.appendChild(p)}const q=document.createElement("div");q.className="is-codeblock-host",P.appendChild(q),f.replaceWith(P),i(q,{value:y.replace(/\n$/,""),mode:b?.mime??"text/plain",theme:"isadocs",lineNumbers:!0,readOnly:"nocursor",viewportMargin:1/0,lineWrapping:!1,tabSize:2,indentUnit:2})}}function C(e){const n=/<!--\s*img\s+([^>]+?)\s*-->/g,i=/(\w+)\s*=\s*"([^"]*)"/g;return e.replace(n,(s,u)=>{const t={};for(const y of u.matchAll(i))t[y[1]]=y[2];const c=t.path;if(!c)return"> ⚠ `<!-- img -->` sin `path`";const b=c.startsWith("/")?c:`/${c}`,f=(t.alt??"").replace(/"/g,"&quot;");if(t.crop){const y=t.width?`data-w="${t.width}"`:"";return`<canvas class="is-imgcrop" data-src="${b}" data-crop="${t.crop}" ${y} aria-label="${f}"></canvas>`}return`<img src="${b}" alt="${f}" />`})}async function F(e){const n=Array.from(e.querySelectorAll("canvas.is-imgcrop"));for(const i of n){const s=i.dataset.src??"",u=(i.dataset.crop??"").split(",").map(y=>parseFloat(y.trim()));if(!s||u.length!==4||u.some(y=>Number.isNaN(y)))continue;const[t,c,b,f]=u;await new Promise(y=>{const P=new Image;P.crossOrigin="anonymous",P.onload=()=>{const p=(parseFloat(i.dataset.w??"")||b)/b;i.width=Math.round(b*p),i.height=Math.round(f*p);const O=i.getContext("2d");O&&O.drawImage(P,t,c,b,f,0,0,i.width,i.height),y()},P.onerror=()=>y(),P.src=s})}}async function z(e){const n=/<!--\s*src\s+([^>]+?)\s*-->/g,i=[...e.matchAll(n)];if(!i.length)return e;const s=/(\w+)\s*=\s*"([^"]*)"/g,u=await Promise.all(i.map(async c=>{const b={};for(const q of c[1].matchAll(s))b[q[1]]=q[2];const f=b.path;if(!f)return{match:c[0],replacement:`> ⚠ include sin \`path\`: \`${c[0]}\``};const y=new URLSearchParams({path:f});for(const q of["from","to","symbol","start","end"])b[q]&&y.set(q,b[q]);const P=b.lang||j(f);try{const q=await fetch(`/api/source?${y.toString()}`,{cache:"no-cache"}),p=await q.text();if(!q.ok)return{match:c[0],replacement:`> ⚠ \`${f}\`: ${p}`};const O="```",Q=`${O}${P}
${p.replace(/```/g,"ʼʼʼ")}
${O}`;return{match:c[0],replacement:Q}}catch(q){return{match:c[0],replacement:`> ⚠ \`${f}\`: ${q?.message??q}`}}}));let t=e;for(const{match:c,replacement:b}of u)t=t.replace(c,()=>b);return t}function j(e){switch(e.split(".").pop()?.toLowerCase()??""){case"ts":case"tsx":return"typescript";case"js":case"jsx":return"javascript";case"sql":return"sql";case"json":return"json";case"yaml":case"yml":return"yaml";case"ps1":return"powershell";case"sh":return"bash";default:return""}}function B(){try{const e=new URLSearchParams(window.location.search).get("state");if(!e)return"";const n=JSON.parse(atob(e));return typeof n?.slug=="string"?n.slug:""}catch{return""}}function se(e){try{const n=btoa(JSON.stringify({slug:e})),i=new URL(window.location.href);i.searchParams.set("state",n),window.history.replaceState({},"",i.toString())}catch{}}async function te(e){x(k,e),se(e),x(R,"");const n=a(m)?.sections.find(i=>i.slug===e);if(!(n?.kind==="prompts"||n?.kind==="modelos"||n?.kind==="endpoints-local")){if(n?.kind==="embeds"){x(R,me(a(m)?.embeds??[])),await xe(),a(_)&&await K(a(_));return}try{const i=Je?`/static-api/docs/${T()}/${e}.md`:`/docs/${T()}/${e}.md`,s=await fetch(i,{cache:"no-cache"});if(!s.ok)throw new Error(`HTTP ${s.status}`);let u=await s.text();u=C(u);const t=window.marked;x(R,t.parse(u,{mangle:!1,headerIds:!0})),await xe();const c=a(_)??document.querySelector(".docs-content");c&&(await fa(c),await g(c),await F(c))}catch(i){x(R,`<p class="docs-error">Error cargando <code>${e}.md</code>: ${i?.message??i}</p>`)}}}const ye="3.11.174";let L=!1;async function A(){if(L&&window.pdfjsLib)return;const e=`https://cdnjs.cloudflare.com/ajax/libs/pdf.js/${ye}`;window.pdfjsLib||await X(`${e}/pdf.min.js`);const n=window.pdfjsLib;n?.GlobalWorkerOptions&&(n.GlobalWorkerOptions.workerSrc=`${e}/pdf.worker.min.js`),L=!!n}async function K(e){const n=Array.from(e.querySelectorAll(".embed-pdf[data-pdf-src]"));if(!n.length)return;try{await A()}catch{n.forEach(s=>{s.innerHTML='<div class="embed-pdf-error">No se pudo cargar el visor de PDF.</div>'});return}const i=window.pdfjsLib;i&&await Promise.all(n.map(async s=>{const u=s.dataset.pdfSrc;if(u)try{const c=await i.getDocument({url:u}).promise;s.innerHTML="";const b=Math.max(1,Math.min(2,(s.clientWidth||800)/700));for(let f=1;f<=c.numPages;f++){const y=await c.getPage(f),P=y.getViewport({scale:b}),q=document.createElement("canvas");q.className="embed-pdf-page",q.width=Math.round(P.width),q.height=Math.round(P.height),s.appendChild(q);const p=q.getContext("2d");p&&await y.render({canvasContext:p,viewport:P}).promise}}catch(t){s.innerHTML=`<div class="embed-pdf-error">Error al renderizar el PDF: ${t?.message??t}</div>`}}))}function me(e){if(!e.length)return'<p class="docs-error">No hay recursos configurados.</p>';const n=t=>t.replace(/&/g,"&amp;").replace(/"/g,"&quot;"),i='<svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor" aria-hidden="true"><path d="M14 3v2h3.59L7.76 14.83l1.41 1.41L19 6.41V10h2V3h-7zM19 19H5V5h7V3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7h-2v7z"/></svg>',s=(t,c)=>`<a class="embed-open" href="${n(t)}" target="_blank" rel="noopener" title="${n(c)}" aria-label="${n(c)}">${i}</a>`,u=["<h1>Recursos insertados</h1>"];for(const t of e){const c=t.title??t.src.split("/").pop()??t.src,b=Ea(t.src),f=n(b);if(t.type==="image")u.push(`<figure class="embed-figure"><div class="embed-head">${s(b,`Abrir ${c} en otra pestaña`)}</div><img class="embed-image" src="${f}" alt="${n(c)}" /></figure>`);else if(t.type==="pdf"){const y=f;u.push(`<figure class="embed-figure"><div class="embed-head">${s(b,`Abrir ${c} en otra pestaña`)}</div><div class="embed-pdf" data-pdf-src="${y}" aria-label="${n(c)}"><div class="embed-pdf-loading">Cargando PDF…</div></div></figure>`)}}return u.join(`
`)}let Z=D(!1),oe=D(!1),ee="",J=D(null),he=null,ce=D(!1);async function ze(){if(!a(m))return"";const e=`/static-api/docs/${T()}`,n=[],i=`# ${a(m).title}

${a(m).description??""}`.trim();n.push(i);for(const s of a(m).sections){if(s.kind==="embeds"||s.kind==="prompts"||s.kind==="modelos"||s.kind==="endpoints-local")continue;const u=await fetch(`${e}/${s.slug}.md`,{cache:"no-cache"});if(!u.ok)continue;let t=await u.text();t=C(t),n.push(`

<!-- ===== ${s.slug} — ${s.title} ===== -->

${t.trim()}`)}return n.join(`

`)}async function qe(){if(!a(Z)){x(Z,!0);try{ee=await ze(),x(oe,!0),await xe(),await Ee()}finally{x(Z,!1)}}}async function Ee(){if(!a(J)||!window.CodeMirror)return;await pe("markdown");const e=window.CodeMirror;la(J,a(J).innerHTML=""),he=e(a(J),{value:ee,mode:"text/x-markdown",theme:"isadocs",lineNumbers:!0,readOnly:"nocursor",viewportMargin:1/0,lineWrapping:!0,tabSize:2,indentUnit:2}),await xe(),he?.refresh()}function $e(){x(oe,!1),he=null}async function _e(){try{await navigator.clipboard.writeText(ee),x(ce,!0),setTimeout(()=>{x(ce,!1)},1500)}catch{}}function Ae(){const e=new Blob([ee],{type:"text/markdown;charset=utf-8"}),n=URL.createObjectURL(e),i=document.createElement("a");i.href=n,i.download=`${T()}-doc.md`,document.body.appendChild(i),i.click(),document.body.removeChild(i),URL.revokeObjectURL(n)}sa(async()=>{try{const e=await fetch(`/docs/${T()}/_index.json`,{cache:"no-cache"});if(!e.ok)throw new Error(`No se encontró _index.json (HTTP ${e.status})`);if(x(m,await e.json()),await Promise.all([de(),re()]),x(M,!1),await xe(),a(m)&&a(m).sections.length>0){const n=B(),i=a(m).sections.find(s=>s.slug===n)?.slug??a(m).sections[0].slug;await te(i)}}catch(e){x(V,e?.message??String(e)),x(M,!1)}}),Qe();var Pe=fn(),ve=we(Pe);{var Oe=e=>{var n=rn();d(e,n)},ke=e=>{var n=on(),i=o(n);r(n),Y(()=>H(i,`⚠ ${a(V)??""}`)),d(e,n)},Ie=e=>{var n=pn(),i=o(n),s=o(i),u=o(s),t=o(u,!0);r(u);var c=v(u,2);{var b=S=>{var h=sn(),I=o(h,!0);r(h),Y(()=>H(I,(a(m),U(()=>a(m).description)))),d(S,h)};ge(c,S=>{a(m),U(()=>a(m).description)&&S(b)})}var f=v(c,2),y=o(f,!0);r(f),r(s);var P=v(s,2);Re(P,5,()=>(a(m),U(()=>a(m).sections)),Fe,(S,h)=>{var I=tn();let le;var Ne=o(I),na=o(Ne,!0);r(Ne);var Be=v(Ne,2),ra=o(Be,!0);r(Be),r(I),Y(oa=>{le=Ke(I,1,"docs-nav-item svelte-1dlwdhb",null,le,{active:a(k)===a(h).slug}),H(na,oa),H(ra,(a(h),U(()=>a(h).title)))},[()=>(a(h),U(()=>(a(h).slug.split("/").pop()??a(h).slug).split("-")[0]))]),Ce("click",I,()=>te(a(h).slug)),d(S,I)}),r(P),r(i);var q=v(i,2);{var p=S=>{var h=cn(),I=o(h);Ia(I),r(h),Te(h,le=>x(_,le),()=>a(_)),d(S,h)},O=De(()=>(a(m),a(k),U(()=>a(m).sections.find(S=>S.slug===a(k))?.kind==="prompts"))),Q=S=>{var h=ln(),I=o(h);La(I,{}),r(h),Te(h,le=>x(_,le),()=>a(_)),d(S,h)},Se=De(()=>(a(m),a(k),U(()=>a(m).sections.find(S=>S.slug===a(k))?.kind==="modelos"))),Ze=S=>{var h=dn(),I=o(h);nn(I,{}),r(h),Te(h,le=>x(_,le),()=>a(_)),d(S,h)},ea=De(()=>(a(m),a(k),U(()=>a(m).sections.find(S=>S.slug===a(k))?.kind==="endpoints-local"))),aa=S=>{var h=un();Ye(h,()=>a(R),!0),r(h),Te(h,I=>x(_,I),()=>a(_)),d(S,h)};ge(q,S=>{a(O)?S(p):a(Se)?S(Q,1):a(ea)?S(Ze,2):S(aa,-1)})}r(n),Y(()=>{H(t,(a(m),U(()=>a(m).title))),f.disabled=a(Z),H(y,a(Z)?"Generando…":"📄 Ver MD completo")}),Ce("click",f,qe),d(e,n)};ge(ve,e=>{a(M)?e(Oe):a(V)?e(ke,1):a(m)&&e(Ie,2)})}var l=v(ve,2);{var $=e=>{var n=mn(),i=o(n),s=o(i),u=o(s),t=o(u);r(u);var c=v(u,2),b=o(c);{let p=Ge(()=>a(ce)?"mdi:check":"mdi:content-copy"),O=Ge(()=>a(ce)?"success":"primary"),Q=Ge(()=>a(ce)?"Copiado":"Copiar al portapapeles");Le(b,{get icon(){return a(p)},get color(){return a(O)},get title(){return a(Q)},$$events:{click:_e}})}var f=v(b,2);Le(f,{icon:"mdi:download",color:"primary",title:"Descargar como .md",$$events:{click:Ae}});var y=v(f,2);Le(y,{icon:"mdi:close",title:"Cerrar",$$events:{click:$e}}),r(c),r(s);var P=v(s,2),q=o(P);Te(q,p=>x(J,p),()=>a(J)),r(P),r(i),r(n),Y(()=>H(t,`📄 Documentación completa — ${T()??""}`)),Ce("click",i,ma(function(p){ua.call(this,ae,p)})),Ce("click",n,$e),Ce("keydown",n,p=>{p.key==="Escape"&&$e()}),d(e,n)};ge(l,e=>{a(oe)&&e($)})}d(N,Pe),He()}export{Rn as default};
