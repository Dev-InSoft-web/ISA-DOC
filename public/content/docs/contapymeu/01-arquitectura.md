...
![Diagrama UML de componentes](/assets/imgs/030%20Capacitaci%C3%B3n.png)

> El diagrama oficial está en `public/assets/imgs/030 Capacitación.png`.
...
Imágenes alojadas en `public/assets/imgs/` (visibles también en la sub-pestaña
