...
`src/lib/tickets/assets/imgbb-map.json`. El merge resolvió tomando la
...
const old=JSON.parse(cp.execSync('git show <hash>:src/lib/tickets/assets/imgbb-map.json'));
const p='src/lib/tickets/assets/imgbb-map.json';
