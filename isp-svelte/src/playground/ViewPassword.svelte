<script lang="ts">
   ...
   let value: string = "";
   let svg: string = `<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
         ...
         <table>
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td>string</td>
                  <td>false</td>
                  <td><input type="text" bind:value={svg} /></td>
               ...
               <tr>
                  ...
                  <td>number</td>
                  <td>false</td>
                  <td><input type="text" bind:value={maxLength} /></td>
                  <td>Indica el tamaño máximo del input del componente</td>
               </tr>
            </tbody>
         </table>
         <h3>Previsualizacion</h3>

         <InputPass {id} {required} {readonly} {name} {label} {maxLength} bind:value {onChange} {onTypingEnd}>
