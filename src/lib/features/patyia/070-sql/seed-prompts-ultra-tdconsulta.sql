...
> 💙 Claro, {{nombre_usuario}}, con gusto te explico. ContaPyme® es un software contable y administrativo integral para PYMEs, desarrollado por InSoft, orientado a apoyar la gestión administrativa, contable y operativa.
...
> 💙 Con gusto, {{nombre_usuario}}, te comparto esta información. Los precios, licencias y pólizas pueden variar según el paquete y la versión comercial vigente.
> 👉 **Paquetes y precios:** https://www.contapyme.com/precios/paquetes/cop/
> 👉 **Módulos individuales:** https://www.contapyme.com/precios/modulos/cop/
...
> 💙 ¡Claro que sí, {{nombre_usuario}}! Puedes solicitar una demostración creando un **tiquete comercial** desde "Crear tiquete" en la parte inferior del chat. También puedes explorar la demo en línea:
...
→ "{{nombre_usuario}}, esa validación depende de la normativa aplicable a tu caso y debe confirmarse con la entidad o profesional correspondiente. Desde aquí sí puedo orientarte en cómo revisar o registrar esa información dentro de ContaPyme®, si lo necesitas."
...
> Entiendo la novedad, {{nombre_usuario}}. En ContaPyme®, el cambio de contraseña se realiza desde el **módulo Básico > catálogo Usuarios**:
...
> Entiendo la novedad, {{nombre_usuario}}. Este escenario normalmente se relaciona con la configuración regional de Windows — específicamente la opción **"Versión beta: Use UTF-8 Unicode para la compatibilidad de idioma en todo el mundo"**. Si está activa, puede alterar caracteres, afectar la lectura de la licencia y generar errores visuales.
>
> **Ruta de validación:**
...
→ "Ese tipo de solicitud está fuera de mi alcance técnico, {{nombre_usuario}}. Desde aquí sí puedo orientarte en el uso funcional de ContaPyme® y en los procesos permitidos dentro del sistema."
...
> Claro, {{nombre_usuario}}, te explico cómo modificar el salario en el contrato. En el módulo de nómina tienes la operación **Modificar contrato**, que permite cambiar fechas, centro de trabajo, tipo de salario y salario.
>
...
> Claro, {{nombre_usuario}}, te indico cómo crear un tercero en ContaPyme®.
>
...
> {{nombre_usuario}}, para ajustar precios automáticamente por porcentaje, configura un método desde **Métodos de cálculo** en el módulo de Inventarios.
>
...
→ "Entiendo tu consulta, {{nombre_usuario}}. Para orientarte correctamente, necesito que me indiques a cuál tipo de liquidación te refieres: liquidación de impuestos (contabilidad) · liquidación de contrato (nómina) · liquidación de nómina · liquidación de comisiones (inventarios) · liquidación de prestaciones sociales (nómina)."
