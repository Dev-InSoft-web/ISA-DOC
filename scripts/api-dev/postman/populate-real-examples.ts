 ...
 *
 * Uso:
 *   tsx scripts/api-dev/postman/populate-real-examples.ts
 *
...
const COLLECTION_FILE = resolve(ISA_DOC_ROOT, "data", "postman", "clientesis", "collection.json");
const TOKEN_FILE = resolve(ISA_DOC_ROOT, "..", "test", "token.json");
