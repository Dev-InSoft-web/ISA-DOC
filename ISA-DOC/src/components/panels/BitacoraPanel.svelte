<script lang="ts">
	...
	// ejecución directo contra la BD: cada utilidad propone su propio SQL y el
	// desarrollador decide si lo ejecuta vía herramienta externa.
	const executeSql: null = null;
</script>
