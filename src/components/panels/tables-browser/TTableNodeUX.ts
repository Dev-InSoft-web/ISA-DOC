...
import type { WardenAction, WardenDraft } from "$comps/tree/TreeViewLegacy/_treeAdapter/06-roles";
import type { INode } from "$comps/tree/TreeViewLegacy/_treeAdapter/_defgen/00-tree-data";
