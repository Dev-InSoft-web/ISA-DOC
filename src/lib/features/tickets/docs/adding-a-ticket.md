...
6. **Assets** — Carpeta `assets/patyia/06/04/TK-1433999/`; subir con `npm run assets:upload` y luego `npm run assets:prune` (solo queda `_meta/imgbb-map.json`; en TS usar `ticketImg("archivo.png")`).
