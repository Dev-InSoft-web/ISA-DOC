...
import { segmentsToTimestampedLines, videoCorpusMarkdown } from "./youtube-transcript-md.ts";
...
async function main(): Promise<void> {
	...
	if (!videoId) {
		console.error("Uso: npx tsx scripts/lab-langgraph/youtube-proofread-openai.mts <videoId>");
		process.exit(1);
	}
