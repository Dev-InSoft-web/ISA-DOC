...
export const TICKETS: TicketRegistro[] = [
	...
	},
	{
		...
		commits: [
			{ hash: "cf6db0f", descripcion: "feat(capacitacion): se aplican ajustes varios sobre cursos planes de estudio y recursos incluyendo arbol de contenido", repo: "ISW-ClientesIS", ins: 59, del: 23, fecha: "2026-05-21T09:23:02-05:00" },
			{ hash: "4f9f495", descripcion: "feat(capacitacion): se agrega opcion de ir a ver el curso o el plan desde los catalogos de cursos y planes de estudio", repo: "ISW-ClientesIS", ins: 39, del: 2, fecha: "2026-05-21T09:41:10-05:00" },
		],
		body: bodyTK1426728,
		normativa: { ...NORMATIVA_DEFAULT, tipoSolicitud: "1 - PQR Error del sistema" },
	},
	{
		...
		commits: [
			...
			{ hash: "f1fbcb4", descripcion: "fix(TK-1426681): se ajustan campos de auditoria para duplicar recodificar y consolidar", repo: "ISP-CLientesISServer", ins: 26, del: 1, fecha: "2026-05-21T11:14:58-05:00" },
			...
			{ hash: "f3b4809", descripcion: "feat(plan-estudio): se agregan metodos del server para insertar detalles y manejar cursos y prerrequisitos del plan de estudio", repo: "ISP-CLientesISServer", ins: 12, del: 13, fecha: "2026-05-21T10:15:03-05:00" },
			{ hash: "16b859b", descripcion: "fix(cursos): se ajusta el codigo de error del server cambiando 400 por 404 cuando no encuentra el recurso", repo: "ISP-CLientesISServer", ins: 7, del: 7, fecha: "2026-05-21T09:25:23-05:00" },
			{ hash: "a7c70c6", descripcion: "feat(capacitacion): se realiza validacion previa al plan de estudio y al curso en el server", repo: "ISP-CLientesISServer", ins: 11, del: 3, fecha: "2026-05-21T08:57:26-05:00" },
		],
		body: bodyTK1426681,
		normativa: { ...NORMATIVA_DEFAULT, tipoSolicitud: "1 - PQR Error del sistema" },
	},
