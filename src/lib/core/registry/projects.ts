...
export const PROJECTS: ProjectEntry[] = [
	...
	// 4) ISW-ClientesIS
	{
		...
		actions: [
			...
			{ id: "isw-iconify", label: "Descargar iconos", type: "build", command: "npm run iconify", cwd: `${base}/ClientesIS/ISW-ClientesIS`, description: "Iconify dl → public/assets/icons/iconify" },
		],
	},
