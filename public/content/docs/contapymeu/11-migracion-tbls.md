...
> El código vive en `doc/ISA-DOC/src/lib/sql/migration/` (núcleo, DDL, drivers, estructuras, inspección, performance, SQL y verificación). Esta página documenta la operación.
