...
export const TICKETS: TicketRegistro[] = [
	{
		...
		commits: [
			{ hash: "44b6de6", repo: "ISA-DOC", descripcion: "feat(TK-1431666): Se añade script de métricas de tokens y se unifica nomenclatura PROMPT_<TIPO>.md", ins: 4419, del: 2383, fecha: "2026-06-02T11:49:24-05:00" },
			{ hash: "40995ce", repo: "ISA-DOC", descripcion: "feat(TK-1431666): Se actualiza cuerpo del ticket, gráficos de tokens y visor asíncrono de diligencia", ins: 1330, del: 308, fecha: "2026-06-02T08:02:56-05:00" },
			{ hash: "ce07c0d", repo: "ISA-DOC", descripcion: "feat(TK-1431666): Se refinan prompts Ultra e integra script seed-prompts-ultra-tdconsulta.sql", ins: 3991, del: 1971, fecha: "2026-06-02T07:20:36-05:00" },
			{ hash: "5701057", repo: "ISA-DOC", descripcion: "refactor(TK-1431666): Se eliminan scripts SQL obsoletos y se actualizan referencias en bitácora PatyIA", ins: 224, del: 121, fecha: "2026-06-01T15:21:34-05:00" },
			{ hash: "26617c7", repo: "ISA-DOC", descripcion: "docs(TK-1431666): Se documentan lineamientos PATY en variantes wenyan-ultra (referencia de compactación)", ins: 1049, del: 28, fecha: "2026-05-29T12:41:55-05:00" },
			{ hash: "9adce9d", repo: "ISA-DOC", descripcion: "docs(TK-1431666): Se agregan borradores de prompts de asistencia ContaPyme previos a Ultra", ins: 0, del: 0, fecha: "2026-05-29T12:34:21-05:00" },
			{ hash: "e714ffd", repo: "ISA-DOC", descripcion: "feat(TK-1431666): Se agregan scripts SQL de instrucciones y APIs locales de prueba de motores", ins: 6509, del: 91, fecha: "2026-05-29T12:20:50-05:00" },
		],
		cambiosBd: [
			{
				...
				sql: [
					...
					"\tN'<TIPO>',",
					"\tN'PROMPT_<TIPO>',",
					"\tN'<contenido del archivo Ultra/*.md>',",
					...
					"",
					"-- (13 bloques, uno por TIPO; script completo en seed-prompts-ultra-tdconsulta.sql)",
					"COMMIT;",
				].join("\n"),
			},
		],
	...
	},
	{
		...
		extraMinutos: 20,
		resumen:
			"Se agregó INSTRUCCION.MODELO y resolución por tipo (operativo gpt-4.1-nano; respuesta por MODELO en BD, calibrado a gpt-5-nano en las 13 filas Ultra; fallback modeloConversacion gpt-5-nano). Métricas de tokens/costo por turno. Incidente previo por temperature en GPT-5 cerrado con modelosSinTemperatura.",
		get body(): Promise<string> {
		...
		commits: [
			...
			{ hash: "49a01b0", descripcion: "feat(TK-1431662): Se homogeneiza nomenclatura y se catalogan modelos sin parámetro de temperatura", repo: "PatyIA", ins: 216, del: 254, fecha: "2026-06-01T12:49:57-05:00" },
			...
			{ hash: "05c6cef", descripcion: "feat(TK-1431662): Se agrega modelo de respuesta por tipo de consulta desde base de datos", repo: "PatyIA", ins: 179, del: 176, fecha: "2026-06-01T11:57:14-05:00" },
			{ hash: "d113366", descripcion: "feat(TK-1431662): Se incorpora controlador de peticiones operativas de bajo costo", repo: "PatyIA", ins: 94, del: 0, fecha: "2026-05-29T15:38:15-05:00" },
			{ hash: "9eb1917", repo: "ISA-DOC", descripcion: "feat(TK-1431662): Se agrega registro y métricas en motores del laboratorio de conversación", ins: 804, del: 113, fecha: "2026-06-01T12:08:28-05:00" },
		],
		cambiosBd: [
			{
				tabla: "INSTRUCCION (AYUDASCP_IA)",
				registro: "Columna MODELO (migración)",
				intencion: "Se agregó la columna MODELO NVARCHAR(40) NOT NULL con default gpt-5-nano si no existía (DDL). Script add-modelo-instruccion.sql; el UPDATE masivo de filas quedó en calibración.",
				sql: [
					"SET NOCOUNT ON;",
					"SET XACT_ABORT ON;",
					"",
			...
			{
				tabla: "INSTRUCCION (AYUDASCP_IA_STAGING)",
				registro: "Calibración MODELO = gpt-5-nano (todas las filas)",
				intencion: "Se actualizó MODELO a gpt-5-nano en todas las filas de INSTRUCCION tras cargar prompts Ultra (2.0-ultra). Ejecutado vía update-instruccion-modelo-gpt5-nano.sql en bitácora.",
				sql: [
					"SET NOCOUNT ON;",
					"SET XACT_ABORT ON;",
					"BEGIN TRAN;",
	...
	},
	{
		...
		resumen: "Se corrigió la composición OpenAI: PR_GENERAL v13 con variables nombre_usuario e instrucion_tipo (texto desde BD), sin instructions en el body. Se retiraron helpers redundantes en system-prompts.json, se mantuvieron vector stores, resolveUserNameInText y carga de precios UlMetrics con fallback.",
		get body(): Promise<string> {
		...
		commits: [
			...
			{ hash: "1101d47", descripcion: "feat(TK-1431163): Se envían instrucciones por tipo y nombre de usuario en el prompt general", repo: "PatyIA", ins: 183, del: 105, fecha: "2026-06-01T12:55:09-05:00" },
			{ hash: "d8bf73b", descripcion: "refactor(TK-1431163): Se retira proveedor alternativo de operativas y se ajusta carga de precios", repo: "PatyIA", ins: 19, del: 97, fecha: "2026-06-01T10:19:35-05:00" },
			{ hash: "dd46d98", descripcion: "refactor(TK-1431163): Se depura código en servicios de conversaciones y propietario", repo: "PatyIA", ins: 9, del: 18, fecha: "2026-05-29T12:40:51-05:00" },
			{ hash: "a9808b7", descripcion: "feat(TK-1431163): Se optimiza gestión de conversaciones con instrucciones por tipo en el prompt general", repo: "PatyIA", ins: 630, del: 101, fecha: "2026-05-29T12:24:36-05:00" },
			{ hash: "d4e3f75", descripcion: "refactor(TK-1431163): Se depura código en métricas de conversación", repo: "PatyIA", ins: 0, del: 21, fecha: "2026-05-29T12:40:04-05:00" },
			{ hash: "8a5bee3", descripcion: "refactor(TK-1431163): Se depura código en el servicio de inteligencia artificial", repo: "PatyIA", ins: 1, del: 1, fecha: "2026-05-29T12:40:26-05:00" },
			{ hash: "979faa9", descripcion: "refactor(TK-1431163): Se depura código en trazas de diagnóstico", repo: "PatyIA", ins: 3, del: 3, fecha: "2026-05-29T12:38:33-05:00" },
			{ hash: "218341e", descripcion: "refactor(TK-1431163): Se depura código en entidad de tiquete", repo: "PatyIA", ins: 0, del: 1, fecha: "2026-05-29T12:38:06-05:00" },
			{ hash: "2a92bb4", descripcion: "refactor(TK-1431163): Se depura código en controlador principal del asistente", repo: "PatyIA", ins: 4, del: 39, fecha: "2026-05-29T12:37:31-05:00" },
			{ hash: "7c81e1a", descripcion: "refactor(TK-1431163): Se depura código en cierre de conversaciones inactivas", repo: "PatyIA", ins: 1, del: 7, fecha: "2026-05-29T12:37:16-05:00" },
			{ hash: "832d431", descripcion: "refactor(TK-1431163): Se depura código en servicio de información HTTP", repo: "PatyIA", ins: 0, del: 2, fecha: "2026-05-29T12:36:53-05:00" },
			{ hash: "1097a76", repo: "ISA-DOC", descripcion: "docs(TK-1431163): Se agrega entrada de bitácora y referencias de diligencia", ins: 230, del: 148, fecha: "2026-06-01T10:26:34-05:00" },
		],
	...
	},
	{
		...
		commits: [
			...
			{ hash: "78b22cb", repo: "ISA-DOC", descripcion: "Se agrega accordeón 2026-05-26 con SQL exec para NINSTRUCCION en bitácora de PatyIA" },
			{ hash: "2c287df", repo: "ISA-DOC", descripcion: "Se consolidan los dos accordeones SQL del 2026-05-25 en uno solo" },
		],
		cambiosBd: [
			{
				tabla: "INSTRUCCION + TDCONSULTAXINSTRUCCION (AYUDASCP_IA)",
	...
	},
	{
		...
		body: bodyTK1429349,
		commits: [
			{ hash: "9f3247c", descripcion: "feat(TK-1429349): se separa el controlador de driver en su propio archivo", repo: "ISP-CLientesISServer", ins: 30, del: 0, fecha: "2026-05-25T11:12:14-05:00" },
			{ hash: "ebe72f5", descripcion: "feat(TK-1429349): se eliminan los archivos consolidados de plan de estudio y cursos", repo: "ISP-CLientesISServer", ins: 0, del: 353, fecha: "2026-05-25T11:13:17-05:00" },
			{ hash: "9b7727b", descripcion: "feat(TK-1429349): se simplifica el controlador base de capacitacion y se eliminan funciones no usadas", repo: "ISP-CLientesISServer", ins: 21, del: 107, fecha: "2026-05-25T11:13:31-05:00" },
			{ hash: "8f16432", descripcion: "feat(TK-1429349): se simplifican tipos base y se agrega el controlador de permiso", repo: "ISP-CLientesISServer", ins: 16, del: 51, fecha: "2026-05-25T11:14:15-05:00" },
			{ hash: "b816671", descripcion: "feat(TK-1429349): se separa el controlador de atributos por driver con sql expandido", repo: "ISP-CLientesISServer", ins: 33, del: 0, fecha: "2026-05-25T11:14:48-05:00" },
			{ hash: "5763388", descripcion: "feat(TK-1429349): se separa el controlador de estructura de curso con sql expandido", repo: "ISP-CLientesISServer", ins: 20, del: 0, fecha: "2026-05-25T11:15:22-05:00" },
			{ hash: "cfd07d8", descripcion: "feat(TK-1429349): se separa el controlador de seguridad de curso con sql expandido", repo: "ISP-CLientesISServer", ins: 34, del: 0, fecha: "2026-05-25T11:15:52-05:00" },
			{ hash: "e6563b0", descripcion: "feat(TK-1429349): se separa el controlador de atributos de plan con sql expandido", repo: "ISP-CLientesISServer", ins: 34, del: 0, fecha: "2026-05-25T11:16:20-05:00" },
			{ hash: "c923ea8", descripcion: "feat(TK-1429349): se separa el controlador de plan de curso con sql expandido", repo: "ISP-CLientesISServer", ins: 54, del: 0, fecha: "2026-05-25T11:16:53-05:00" },
			{ hash: "98f76cc", descripcion: "feat(TK-1429349): se separa el controlador de curso con sql expandido", repo: "ISP-CLientesISServer", ins: 129, del: 0, fecha: "2026-05-25T11:17:16-05:00" },
			{ hash: "250cf9c", descripcion: "feat(TK-1429349): se separa el controlador de curso prerequisito con sql expandido", repo: "ISP-CLientesISServer", ins: 33, del: 0, fecha: "2026-05-25T11:18:43-05:00" },
			{ hash: "00cccc1", descripcion: "feat(TK-1429349): se separa el controlador de curso de plan de estudio con sql expandido", repo: "ISP-CLientesISServer", ins: 34, del: 0, fecha: "2026-05-25T11:19:11-05:00" },
			{ hash: "08b8987", descripcion: "feat(TK-1429349): se separa el controlador de plan de estudio con sql expandido", repo: "ISP-CLientesISServer", ins: 160, del: 0, fecha: "2026-05-25T11:19:47-05:00" },
			{ hash: "9bc1fee", descripcion: "feat(TK-1429349): se ajusta el insert del controlador de atributos por driver para listas vacias", repo: "ISP-CLientesISServer", ins: 10, del: 7, fecha: "2026-05-25T11:34:05-05:00" },
			{ hash: "645214b", descripcion: "feat(TK-1429349): se ajusta el insert del controlador de estructura de curso para listas vacias", repo: "ISP-CLientesISServer", ins: 10, del: 7, fecha: "2026-05-25T11:35:48-05:00" },
			{ hash: "3d0a2b4", descripcion: "feat(TK-1429349): se ajusta el insert del controlador de seguridad de curso para listas vacias", repo: "ISP-CLientesISServer", ins: 10, del: 7, fecha: "2026-05-25T11:35:59-05:00" },
			{ hash: "54ca961", descripcion: "feat(TK-1429349): se ajusta el insert del controlador de atributos de plan para listas vacias", repo: "ISP-CLientesISServer", ins: 12, del: 8, fecha: "2026-05-25T11:36:34-05:00" },
			{ hash: "27a202a", descripcion: "feat(TK-1429349): se ajusta el insert del controlador de plan de curso para listas vacias", repo: "ISP-CLientesISServer", ins: 11, del: 8, fecha: "2026-05-25T11:36:51-05:00" },
			{ hash: "210b0e6", descripcion: "feat(TK-1429349): se ajusta el insert de los controladores de curso prerequisito y curso de plan", repo: "ISP-CLientesISServer", ins: 30, del: 21, fecha: "2026-05-25T11:37:26-05:00" },
			{ hash: "d0b798e", descripcion: "feat(TK-1429349): se ajusta el tipo de idriver a number en el insert de atributos por driver", repo: "ISP-CLientesISServer", ins: 1, del: 1, fecha: "2026-05-25T11:44:10-05:00" },
		],
		normativa: { ...NORMATIVA_DEFAULT, medioAtencion: "Asistencia remota", tipoSolicitud: "1 - PQR Ajuste del sistema" },
	},
	{
